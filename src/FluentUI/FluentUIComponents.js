...
let a = r;
const l = "fast-" + Math.random().toString(36).substring(2, 8),
  c = l + "{",
  h = "}" + l,
  d = Object.freeze({
...
class p {
  ...
  subscribe(t, e) {
    ...
    if (e) {
      ...
      (this.sourceSubscribers = null !== (i = this.sourceSubscribers) && void 0 !== i ? i : new u(this.source)),
...
function w(t, e) {
  (this.source = t),
    (this.context = e),
    null === this.bindingObserver && (this.bindingObserver = g.binding(this.binding, this, this.isBindingVolatile)),
...
function S(t) {
  if ((null == t && (t = ""), t.create)) {
    ...
    void 0 === e
      ? (e = t.create())
      : this.target.$fastTemplate !== t && (e.isComposed && (e.remove(), e.unbind()), (e = t.create())),
      e.isComposed
        ? e.needsBindOnly && ((e.needsBindOnly = !1), e.bind(this.source, this.context))
        : ((e.isComposed = !0),
    ...
    void 0 !== e &&
      e.isComposed &&
      ((e.isComposed = !1), e.remove(), e.needsBindOnly ? (e.needsBindOnly = !1) : e.unbind()),
...
class V extends x {
  constructor(t) {
    super(),
      ...
      (this.unbind = C),
      (this.updateTarget = D),
      (this.isBindingVolatile = g.isVolatileBinding(this.binding));
  }
  get targetName() {
  ...
  set targetName(t) {
    if (((this.originalTargetName = t), void 0 !== t))
      switch (t[0]) {
        case ":":
          if (
            ((this.cleanedTargetName = t.substr(1)), (this.updateTarget = O), "innerHTML" === this.cleanedTargetName)
          ) {
...
function P(t) {
  ...
  let e;
  const i = t.length,
    o = t.map((t) => ("string" == typeof t ? () => t : ((e = t.targetName || e), t.binding))),
    s = new V((t, e) => {
      let s = "";
...
function M(t, e, i = !1) {
  ...
  for (let s = 0, n = o.length; s < n; ++s) {
    const r = o[s],
      ...
      l = H(t, a);
    let c = null;
    null === l ? i && ((c = new V(() => a)), (c.targetName = r.name)) : (c = P(l)),
...
function B(t, e, i) {
  ...
  if (null !== o) {
    ...
    for (let n = 0, r = o.length; n < r; ++n) {
      const r = o[n],
        a = 0 === n ? e : s.parentNode.insertBefore(document.createTextNode(""), s.nextSibling);
      "string" == typeof r ? (a.textContent = r) : ((a.textContent = " "), t.captureContentBinding(r)),
        (s = a),
        t.targetIndex++,
        a !== e && i.nextNode();
    }
  ...
  create(t) {
    if (null === this.fragment) {
      ...
      const i = (function (t, e) {
        ...
        let a = 0;
        (d.isMarker(i.firstChild) || (1 === i.childNodes.length && e.length)) &&
...
function K(t) {
  return t
    .map((t) => (t instanceof G ? t.behaviors : null))
...
class J extends G {
  constructor(t) {
    super(),
      ...
      (this.behaviors = null),
      (this.behaviors = K(t)),
      (this.styleSheets = W(t)),
      (this.styleClass = "fast-style-class-" + ++Z);
  }
  addStylesTo(t) {
...
const tt = Object.freeze({ locate: s() }),
  et = { toView: (t) => (t ? "true" : "false"), fromView: (t) => null != t && "false" !== t && !1 !== t && 0 !== t },
  it = {
    toView(t) {
...
class ot {
  constructor(t, e, i = e.toLowerCase(), o = "reflect", s) {
    (this.guards = new Set()),
      ...
      "boolean" === o && void 0 === s && (this.converter = et);
  }
  setValue(t, e) {
...
class lt {
  constructor(t, e = t.definition) {
    ...
    const i = ot.collect(t, e.attributes),
    ...
    (this.attributes = i),
      ...
      (this.elementOptions = void 0 === e.elementOptions ? rt : Object.assign(Object.assign({}, rt), e.elementOptions)),
      (this.styles =
        void 0 === e.styles
          ? void 0
          : Array.isArray(e.styles)
          ? G.create(e.styles)
          : e.styles instanceof G
          ? e.styles
          : G.create([e.styles]));
  }
  get isDefined() {
...
const ct = new WeakMap(),
  ht = { bubbles: !0, composed: !0, cancelable: !0 };
function dt(t) {
...
class ut extends p {
  ...
  emit(t, e, i) {
    return (
      !!this._isConnected &&
      this.element.dispatchEvent(new CustomEvent(t, Object.assign(Object.assign({ detail: e }, ht), i)))
    );
  }
  ...
  renderTemplate(t) {
    const e = this.element,
      i = dt(e) || e;
    null !== this.view ? (this.view.dispose(), (this.view = null)) : this.needsInitialization || d.removeChildNodes(i),
      ...
      (function (t, e, i, o, s, n) {
        ...
        for (let i = 1; i < r; ++i)
          for (let n = 1; n < a; ++n)
            t[e + n - 1] === o[s + i - 1]
              ? (l[i][n] = l[i - 1][n - 1])
              : ((c = l[i - 1][n] + 1), (h = l[i][n - 1] + 1), (l[i][n] = c < h ? c : h));
        return l;
      })(t, e, i, s, n, r),
    ),
    d = [];
...
function kt(t, e, i, o) {
  ...
  for (let e = 0; e < t.length; e++) {
    ...
    const o =
      ...
      l < c || h < a ? -1 : l === c || h === a ? 0 : a < c ? (l < h ? l - c : h - c) : h < l ? h - a : l - a);
    if (o >= 0) {
...
function Ct(t, e) {
  ...
  for (let e = 0, s = o.length; e < s; ++e) {
    ...
    1 !== s.addedCount || 1 !== s.removed.length
      ? (i = i.concat($t(t, s.index, s.index + s.addedCount, s.removed, 0, s.removed.length)))
...
function Ft(t, e) {
  ...
  const o = e.length;
  return (
    i > o ? (i = o - t.addedCount) : i < 0 && (i = o + t.removed.length + i - t.addedCount),
    i < 0 && (i = 0),
    (t.index = i),
    t
  );
...
class Dt extends u {
  constructor(t) {
    super(t),
      ...
      Reflect.defineProperty(t, "$fastController", { value: this, enumerable: !1 });
  }
  subscribe(t) {
  ...
  addSplice(t) {
    void 0 === this.splices ? (this.splices = [t]) : this.splices.push(t),
      this.needsQueue && ((this.needsQueue = !1), d.queueUpdate(this));
  }
  reset(t) {
...
class At {
  constructor(t, e, i, o, s, n) {
    (this.location = t),
      ...
      (this.bindView = Vt),
      (this.itemsBindingObserver = g.binding(e, this, i)),
      (this.templateBindingObserver = g.binding(o, this, s)),
      n.positioning && (this.bindView = Rt);
  }
  bind(t, e) {
    (this.source = t),
  ...
  updateViews(t) {
    ...
    for (let h = 0, d = t.length; h < d; ++h) {
      ...
      let p = 0,
        g = d.index;
      const f = g + d.addedCount,
        m = i.splice(d.index, u.length),
        v = (c = a.length + m.length);
      for (; g < f; ++g) {
        const t = i[g],
          h = t ? t.firstChild : this.location;
        let d;
        r && c > 0 ? (p <= v && m.length > 0 ? ((d = m[p]), p++) : ((d = a[l]), l++), c--) : (d = n.create()),
          i.splice(g, 0, d),
          o(d, s, g, e),
          d.insertBefore(h);
      }
...
class Lt extends y {
  constructor(t, e, i) {
    super(),
      ...
      (this.options = i),
      (this.createPlaceholder = d.createBlockPlaceholder),
      (function () {
        if (It) return;
        ...
        (t.pop = function () {
          ...
          (t.splice = function () {
            ...
            return (
              void 0 !== e &&
                e.addSplice(Ft(xt(+arguments[0], t, arguments.length > 2 ? arguments.length - 2 : 0), this)),
              t
            );
          }),
          (t.unshift = function () {
      ...
      (this.isItemsBindingVolatile = g.isVolatileBinding(t)),
      (this.isTemplateBindingVolatile = g.isVolatileBinding(e));
  }
  createBehavior(t) {
    return new At(
      t,
...
const qt = (t, e) =>
    _`<span part="end" ${St("endContainer")} class=${(t) => (e.end ? "end" : void 0)}><slot name="end" ${St(
      "end",
    )} @slotchange="${(t) => t.handleEndContentChange()}">${e.end || ""}</slot></span>`,
  _t = (t, e) =>
    _`<span part="start" ${St("startContainer")} class="${(t) => (e.start ? "start" : void 0)}"><slot name="start" ${St(
      "start",
    )} @slotchange="${(t) => t.handleStartContentChange()}">${e.start || ""}</slot></span>`,
  Gt = _`<span part="end" ${St("endContainer")}><slot name="end" ${St("end")} @slotchange="${(t) =>
    t.handleEndContentChange()}"></slot></span>`,
  Wt = _`<span part="start" ${St("startContainer")}><slot name="start" ${St("start")} @slotchange="${(t) =>
    t.handleStartContentChange()}"></slot></span>`;
/*! *****************************************************************************
...
const Zt = Object.freeze({
    ...
    singleton: (t) => new re(t, 1, t),
    transient: (t) => new re(t, 2, t),
  }),
  Jt = Object.freeze({
...
const oe = Object.freeze({
    ...
    getOrCreateDOMContainer: (t, e) =>
      t
        ? t.$$container$$ || new me(t, Object.assign({}, Jt.default, e, { parentLocator: oe.findParentContainer }))
        : ie || (ie = new me(null, Object.assign({}, Jt.default, e, { parentLocator: () => null }))),
    ...
    createInterface(t, e) {
      const i = "function" == typeof t ? t : e,
        ...
        n = function (t, e, i) {
          ...
          if (e) oe.defineProperty(t, e, n, s);
          else {
    ...
    inject: (...t) =>
      function (e, i, o) {
        if ("number" == typeof o) {
          const i = oe.getOrCreateAnnotationParamTypes(e),
            s = t[0];
          void 0 !== s && (i[o] = s);
        } else if (i) oe.defineProperty(e, i, t[0]);
        else {
  ...
  getFactory(t) {
    ...
    switch (this.strategy) {
      ...
      case 5:
        return null !==
          (o =
            null === (i = null === (e = t.getResolver(this.state)) || void 0 === e ? void 0 : e.getFactory) ||
            void 0 === i
              ? void 0
              : i.call(e, t)) && void 0 !== o
          ? o
...
class ce {
  ...
  construct(t, e) {
    ...
    return (
      (i =
        void 0 === e
          ? new this.Type(...this.dependencies.map(ae, t))
          : new this.Type(...this.dependencies.map(ae, t), ...e)),
      null == this.transformers ? i : this.transformers.reduce(le, i)
    );
  }
...
class me {
  constructor(t, e) {
    (this.owner = t),
      ...
      this.resolvers.set(se, he),
      t instanceof Node &&
        t.addEventListener(ge, (t) => {
  ...
  register(...t) {
    ...
    for (let a = 0, l = t.length; a < l; ++a)
      if (((e = t[a]), ke(e)))
        if (de(e)) e.register(this, r);
        else if (void 0 !== e.prototype) ye.singleton(e, e).register(this);
        else
          for (i = Object.keys(e), s = 0, n = i.length; s < n; ++s)
            (o = e[i[s]]), ke(o) && (de(o) ? o.register(this, r) : this.register(o));
  ...
  registerResolver(t, e) {
    ...
    const i = this.resolvers,
      o = i.get(t);
    return (
      null == o ? i.set(t, e) : o instanceof re && 4 === o.strategy ? o.state.push(e) : i.set(t, new re(t, 4, [o, e])),
      e
    );
  }
...
function Fe(t) {
  switch (typeof t) {
    ...
    case "string": {
      ...
      let o = 0;
      for (let e = 0; e < i; ++e)
        if (((o = t.charCodeAt(e)), (0 === e && 48 === o && i > 1) || o < 48 || o > 57)) return (Ie[t] = !1);
      return (Ie[t] = !0);
    }
    default:
      return !1;
...
class Oe {
  constructor(t, e) {
    (this.template = t || null),
      (this.styles = void 0 === e ? null : Array.isArray(e) ? G.create(e) : e instanceof G ? e : G.create([e]));
  }
  applyTo(t) {
    const e = t.$fastController;
...
class Ee extends gt {
  ...
  static compose(t) {
    return (e = {}) => new Re(this === Ee ? class extends Ee {} : this, t, e);
  }
}
function Ve(t, e, i) {
...
class Re {
  ...
  register(t, e) {
    const i = this.definition,
      ...
      s = `${i.prefix || e.elementPrefix}-${i.baseName}`;
    e.tryDefineElement({
      name: s,
      type: this.type,
      ...
      callback: (t) => {
        ...
        t.shadowRootMode &&
          (s ? o.shadowOptions || (s.mode = t.shadowRootMode) : null !== s && (s = { mode: t.shadowRootMode })),
          t.defineElement({
...
Kt([st({ attribute: "heading-level", mode: "fromView", converter: it })], Le.prototype, "headinglevel", void 0),
  Kt([st({ mode: "boolean" })], Le.prototype, "expanded", void 0),
  Kt([st], Le.prototype, "id", void 0),
  Ae(Le, Ut);
const Pe = "horizontal",
  ze = "vertical";
function He(...t) {
...
class Qe extends Ee {
    ...
    super(...arguments),
      ...
      (this.setItems = () => {
        ...
        if (
          ...
          (null !== (t = this.findExpandedItem()) && void 0 !== t ? t : this.accordionItems[0]).setAttribute(
            "aria-disabled",
            "true",
          );
        }
      ...
      (this.handleItemKeyDown = (t) => {
        if (t.target === t.currentTarget)
          switch (((this.accordionIds = this.getItemIds()), t.key)) {
            case "ArrowUp":
      ...
      (this.handleItemFocus = (t) => {
        if (t.target === t.currentTarget) {
          ...
          this.activeItemIndex !== i &&
            -1 !== i &&
            ((this.activeItemIndex = i), (this.activeid = this.accordionIds[this.activeItemIndex]));
        }
      });
  }
  ...
  findExpandedItem() {
    for (let t = 0; t < this.accordionItems.length; t++)
      if ("true" === this.accordionItems[t].getAttribute("expanded")) return this.accordionItems[t];
    return null;
  }
  resetItems() {
    this.accordionItems.forEach((t, e) => {
...
Kt([st({ attribute: "expand-mode" })], Qe.prototype, "expandmode", void 0),
  Kt([f], Qe.prototype, "accordionItems", void 0);
const Ze = (t, e) =>
  _`<a class="control" part="control" download="${(t) => t.download}" href="${(t) => t.href}" hreflang="${(t) =>
    t.hreflang}" ping="${(t) => t.ping}" referrerpolicy="${(t) => t.referrerpolicy}" rel="${(t) => t.rel}" target="${(
    t,
  ) => t.target}" type="${(t) => t.type}" aria-atomic="${(t) => t.ariaAtomic}" aria-busy="${(t) =>
    t.ariaBusy}" aria-controls="${(t) => t.ariaControls}" aria-current="${(t) => t.ariaCurrent}" aria-describedby="${(
    t,
  ) => t.ariaDescribedby}" aria-details="${(t) => t.ariaDetails}" aria-disabled="${(t) =>
    t.ariaDisabled}" aria-errormessage="${(t) => t.ariaErrormessage}" aria-expanded="${(t) =>
    t.ariaExpanded}" aria-flowto="${(t) => t.ariaFlowto}" aria-haspopup="${(t) => t.ariaHaspopup}" aria-hidden="${(t) =>
    t.ariaHidden}" aria-invalid="${(t) => t.ariaInvalid}" aria-keyshortcuts="${(t) =>
    t.ariaKeyshortcuts}" aria-label="${(t) => t.ariaLabel}" aria-labelledby="${(t) => t.ariaLabelledby}" aria-live="${(
    t,
  ) => t.ariaLive}" aria-owns="${(t) => t.ariaOwns}" aria-relevant="${(t) => t.ariaRelevant}" aria-roledescription="${(
    t,
  ) => t.ariaRoledescription}" ${St("control")}>${_t(0, e)}<span class="content" part="content"><slot ${Bt(
    "defaultSlottedContent",
  )}></slot></span>${qt(0, e)}</a>`;
class Je {}
Kt([st({ attribute: "aria-atomic" })], Je.prototype, "ariaAtomic", void 0),
  Kt([st({ attribute: "aria-busy" })], Je.prototype, "ariaBusy", void 0),
  Kt([st({ attribute: "aria-controls" })], Je.prototype, "ariaControls", void 0),
  Kt([st({ attribute: "aria-current" })], Je.prototype, "ariaCurrent", void 0),
  Kt([st({ attribute: "aria-describedby" })], Je.prototype, "ariaDescribedby", void 0),
  Kt([st({ attribute: "aria-details" })], Je.prototype, "ariaDetails", void 0),
  Kt([st({ attribute: "aria-disabled" })], Je.prototype, "ariaDisabled", void 0),
  Kt([st({ attribute: "aria-errormessage" })], Je.prototype, "ariaErrormessage", void 0),
  Kt([st({ attribute: "aria-flowto" })], Je.prototype, "ariaFlowto", void 0),
  Kt([st({ attribute: "aria-haspopup" })], Je.prototype, "ariaHaspopup", void 0),
  Kt([st({ attribute: "aria-hidden" })], Je.prototype, "ariaHidden", void 0),
  Kt([st({ attribute: "aria-invalid" })], Je.prototype, "ariaInvalid", void 0),
  Kt([st({ attribute: "aria-keyshortcuts" })], Je.prototype, "ariaKeyshortcuts", void 0),
  Kt([st({ attribute: "aria-label" })], Je.prototype, "ariaLabel", void 0),
  Kt([st({ attribute: "aria-labelledby" })], Je.prototype, "ariaLabelledby", void 0),
  Kt([st({ attribute: "aria-live" })], Je.prototype, "ariaLive", void 0),
  Kt([st({ attribute: "aria-owns" })], Je.prototype, "ariaOwns", void 0),
  Kt([st({ attribute: "aria-relevant" })], Je.prototype, "ariaRelevant", void 0),
  Kt([st({ attribute: "aria-roledescription" })], Je.prototype, "ariaRoledescription", void 0);
class ti extends Ee {
  constructor() {
    super(...arguments),
      (this.handleUnsupportedDelegatesFocus = () => {
        ...
        window.ShadowRoot &&
          ...
          (null === (t = this.$fastController.definition.shadowOptions) || void 0 === t ? void 0 : t.delegatesFocus) &&
          (this.focus = () => {
            var t;
...
Kt([st], ti.prototype, "download", void 0),
  Kt([st], ti.prototype, "href", void 0),
  Kt([st], ti.prototype, "hreflang", void 0),
  Kt([st], ti.prototype, "ping", void 0),
  Kt([st], ti.prototype, "referrerpolicy", void 0),
  Kt([st], ti.prototype, "rel", void 0),
  Kt([st], ti.prototype, "target", void 0),
  Kt([st], ti.prototype, "type", void 0),
  Kt([f], ti.prototype, "defaultSlottedContent", void 0);
class ei {}
...
class oi extends Ee {
  constructor() {
    super(...arguments),
        ...
        this.stopObservers(),
          null !== this.anchorElement &&
            ...
            null !== this.resizeDetector &&
              (this.resizeDetector.observe(this.anchorElement), this.resizeDetector.observe(this)));
      }),
      (this.requestPositionUpdates = () => {
        null === this.anchorElement ||
          this.pendingPositioningUpdate ||
          (oi.intersectionService.requestPosition(this, this.handleIntersection),
          oi.intersectionService.requestPosition(this.anchorElement, this.handleIntersection),
          null !== this.viewportElement &&
            oi.intersectionService.requestPosition(this.viewportElement, this.handleIntersection),
          (this.pendingPositioningUpdate = !0));
      }),
      (this.stopObservers = () => {
        this.pendingPositioningUpdate &&
          ((this.pendingPositioningUpdate = !1),
          oi.intersectionService.cancelRequestPosition(this, this.handleIntersection),
          null !== this.anchorElement &&
            oi.intersectionService.cancelRequestPosition(this.anchorElement, this.handleIntersection),
          null !== this.viewportElement &&
            oi.intersectionService.cancelRequestPosition(this.viewportElement, this.handleIntersection)),
      ...
      (this.handleIntersection = (t) => {
        this.pendingPositioningUpdate &&
          ((this.pendingPositioningUpdate = !1), this.applyIntersectionEntries(t) && this.updateLayout());
      }),
      ...
      (this.updateLayout = () => {
        ...
        if ("uncontrolled" !== this.horizontalPositioningMode) {
          ...
          (void 0 === e ||
            ("locktodefault" !== this.horizontalPositioningMode && this.getAvailableSpace(e, o, s, n, r, a) < i)) &&
            (e =
              this.getAvailableSpace(t[0], o, s, n, r, a) > this.getAvailableSpace(t[1], o, s, n, r, a) ? t[0] : t[1]);
        }
        if ("uncontrolled" !== this.verticalPositioningMode) {
          ...
          (void 0 === t ||
            ("locktodefault" !== this.verticalPositioningMode && this.getAvailableSpace(t, o, s, n, r, a) < i)) &&
            (t =
              this.getAvailableSpace(e[0], o, s, n, r, a) > this.getAvailableSpace(e[1], o, s, n, r, a) ? e[0] : e[1]);
        }
        ...
        if (
          ...
          return (this.initialLayoutComplete = !0), void this.requestPositionUpdates();
        this.regionVisible ||
      ...
      (this.setHorizontalPosition = (t, e) => {
        ...
        switch (t) {
          ...
          case "center":
            if (
              ((o = (this.anchorRect.width - i) / 2),
              (this.translateX = this.baseHorizontalOffset + o),
              this.horizontalViewportLock)
            ) {
              const t = this.anchorRect.left + o,
                e = this.anchorRect.right - o;
              t < this.viewportRect.left && !(e > this.viewportRect.right)
                ? (this.translateX = this.translateX - (t - this.viewportRect.left))
                : e > this.viewportRect.right &&
                  !(t < this.viewportRect.left) &&
                  (this.translateX = this.translateX - (e - this.viewportRect.right));
            }
        }
      ...
      (this.setVerticalPosition = (t, e) => {
        ...
        switch (t) {
          ...
          case "center":
            if (
              ((o = (this.anchorRect.height - i) / 2),
              (this.translateY = this.baseVerticalOffset + o),
              this.verticalViewportLock)
            ) {
              const t = this.anchorRect.top + o,
                e = this.anchorRect.bottom - o;
              t < this.viewportRect.top && !(e > this.viewportRect.bottom)
                ? (this.translateY = this.translateY - (t - this.viewportRect.top))
                : e > this.viewportRect.bottom &&
                  !(t < this.viewportRect.top) &&
                  (this.translateY = this.translateY - (e - this.viewportRect.bottom));
            }
        }
      ...
      (this.getNextRegionDimension = (t, e) => {
        ...
        return (
          void 0 !== t && "fill" === this.horizontalScaling
            ...
            : "anchor" === this.horizontalScaling && (i.width = void 0 !== this.anchorRect ? this.anchorRect.width : 0),
          void 0 !== e && "fill" === this.verticalScaling
            ...
            : "anchor" === this.verticalScaling && (i.height = void 0 !== this.anchorRect ? this.anchorRect.height : 0),
          i
        );
      }),
      (this.startAutoUpdateEventListeners = () => {
        window.addEventListener("resize", this.update, { passive: !0 }),
          window.addEventListener("scroll", this.update, { passive: !0, capture: !0 }),
          null !== this.resizeDetector &&
            null !== this.viewportElement &&
  ...
  autoUpdateModeChanged(t, e) {
    this.$fastController.isConnected &&
      this.initialLayoutComplete &&
      ("auto" === t && this.stopAutoUpdateEventListeners(), "auto" === e && this.startAutoUpdateEventListeners());
  }
  ...
  requestReset() {
    this.$fastController.isConnected &&
      !1 === this.pendingReset &&
      (this.setInitialState(), d.queueUpdate(() => this.reset()), (this.pendingReset = !0));
  }
  setInitialState() {
    (this.initialLayoutComplete = !1),
      (this.regionVisible = !1),
...
(oi.intersectionService = new (class {
      ...
      (this.requestPosition = (t, e) => {
        ...
        null !== this.intersectionDetector &&
          (this.observedElements.has(t)
            ? null === (i = this.observedElements.get(t)) || void 0 === i || i.push(e)
            : (this.observedElements.set(t, [e]), this.intersectionDetector.observe(t)));
      }),
  ...
  Kt([st], oi.prototype, "anchor", void 0),
  Kt([st], oi.prototype, "viewport", void 0),
  Kt([st({ attribute: "horizontal-positioning-mode" })], oi.prototype, "horizontalPositioningMode", void 0),
  Kt([st({ attribute: "horizontal-default-position" })], oi.prototype, "horizontalDefaultPosition", void 0),
  Kt([st({ attribute: "horizontal-viewport-lock", mode: "boolean" })], oi.prototype, "horizontalViewportLock", void 0),
  Kt([st({ attribute: "horizontal-inset", mode: "boolean" })], oi.prototype, "horizontalInset", void 0),
  Kt([st({ attribute: "horizontal-threshold" })], oi.prototype, "horizontalThreshold", void 0),
  Kt([st({ attribute: "horizontal-scaling" })], oi.prototype, "horizontalScaling", void 0),
  Kt([st({ attribute: "vertical-positioning-mode" })], oi.prototype, "verticalPositioningMode", void 0),
  Kt([st({ attribute: "vertical-default-position" })], oi.prototype, "verticalDefaultPosition", void 0),
  Kt([st({ attribute: "vertical-viewport-lock", mode: "boolean" })], oi.prototype, "verticalViewportLock", void 0),
  Kt([st({ attribute: "vertical-inset", mode: "boolean" })], oi.prototype, "verticalInset", void 0),
  Kt([st({ attribute: "vertical-threshold" })], oi.prototype, "verticalThreshold", void 0),
  Kt([st({ attribute: "vertical-scaling" })], oi.prototype, "verticalScaling", void 0),
  Kt([st({ attribute: "fixed-placement", mode: "boolean" })], oi.prototype, "fixedPlacement", void 0),
  Kt([st({ attribute: "auto-update-mode" })], oi.prototype, "autoUpdateMode", void 0),
  Kt([f], oi.prototype, "anchorElement", void 0),
  Kt([f], oi.prototype, "viewportElement", void 0),
  Kt([f], oi.prototype, "initialLayoutComplete", void 0);
class si extends Ee {
  constructor() {
    super(...arguments),
...
Kt([st({ attribute: "fill" })], si.prototype, "fill", void 0),
  Kt([st({ attribute: "color" })], si.prototype, "color", void 0),
  Kt([st({ mode: "boolean" })], si.prototype, "circular", void 0);
class ni extends ti {
  constructor() {
...
class ri extends Ee {
  ...
  findChildWithHref(t) {
    ...
    return t.childElementCount > 0
      ...
      : (null === (e = t.shadowRoot) || void 0 === e ? void 0 : e.childElementCount)
  ...
  setAriaCurrent(t, e) {
    ...
    null === i && t.hasAttribute("href") && t instanceof ni
      ? e
        ? t.setAttribute("aria-current", "page")
        : t.removeAttribute("aria-current")
      : null !== i && (e ? i.setAttribute("aria-current", "page") : i.removeAttribute("aria-current"));
  }
}
Kt([f], ri.prototype, "slottedBreadcrumbItems", void 0);
const ai = "ElementInternals" in window && "setFormValue" in window.ElementInternals.prototype,
  li = new WeakMap();
function ci(t) {
  const e = class extends t {
    ...
    disabledChanged(t, e) {
      this.proxy instanceof HTMLElement && (this.proxy.disabled = this.disabled),
        d.queueUpdate(() => this.classList.toggle("disabled", this.disabled));
    }
    nameChanged(t, e) {
    ...
    requiredChanged(t, e) {
      this.proxy instanceof HTMLElement && (this.proxy.required = this.required),
        d.queueUpdate(() => this.classList.toggle("required", this.required)),
        this.validate();
    }
    ...
    connectedCallback() {
      super.connectedCallback(),
        ...
        this.value || ((this.value = this.initialValue), (this.dirtyValue = !1)),
        this.elementInternals ||
          (this.attachProxy(), this.form && this.form.addEventListener("reset", this.formResetCallback));
    }
    disconnectedCallback() {
  ...
  return (
    st({ mode: "boolean" })(e.prototype, "disabled"),
    st({ mode: "fromView", attribute: "value" })(e.prototype, "initialValue"),
    st({ attribute: "current-value" })(e.prototype, "currentValue"),
    st(e.prototype, "name"),
    st({ mode: "boolean" })(e.prototype, "required"),
    f(e.prototype, "value"),
    e
  );
}
function hi(t) {
  ...
  return (
    st({ attribute: "checked", mode: "boolean" })(i.prototype, "checkedAttribute"),
    st({ attribute: "current-checked", converter: et })(i.prototype, "currentChecked"),
    f(i.prototype, "defaultChecked"),
    f(i.prototype, "checked"),
    i
  );
}
class di extends Ee {}
  ...
  constructor() {
    super(...arguments),
      (this.handleClick = (t) => {
        var e;
        this.disabled &&
          (null === (e = this.defaultSlottedContent) || void 0 === e ? void 0 : e.length) <= 1 &&
          t.stopPropagation();
      }),
...
Kt([st({ mode: "boolean" })], pi.prototype, "autofocus", void 0),
  Kt([st({ attribute: "form" })], pi.prototype, "formId", void 0),
  Kt([st], pi.prototype, "formaction", void 0),
  Kt([st], pi.prototype, "formenctype", void 0),
  Kt([st], pi.prototype, "formmethod", void 0),
  Kt([st({ mode: "boolean" })], pi.prototype, "formnovalidate", void 0),
  Kt([st], pi.prototype, "formtarget", void 0),
  Kt([st], pi.prototype, "type", void 0),
  Kt([f], pi.prototype, "defaultSlottedContent", void 0);
class gi {}
Kt([st({ attribute: "aria-expanded" })], gi.prototype, "ariaExpanded", void 0),
  Kt([st({ attribute: "aria-pressed" })], gi.prototype, "ariaPressed", void 0),
  Ae(gi, Je),
  Ae(pi, Ut, gi);
class fi {
  constructor(t) {
  ...
  getDate(
    t = this.date,
    e = { weekday: this.weekdayFormat, month: this.monthFormat, day: this.dayFormat, year: this.yearFormat },
    i = this.locale,
  ) {
  ...
  getWeekdays(t = this.weekdayFormat, e = this.locale) {
    return Array(7)
      .fill(null)
      .map((i, o) => this.getWeekday(o, t, e));
  }
}
class mi extends Ee {
  constructor() {
    super(...arguments),
      (this.dateFormatter = new fi()),
      (this.readonly = !1),
      (this.locale = "en-US"),
  ...
  getMonthInfo(t = this.month, e = this.year) {
    const i = (t) => new Date(t.getFullYear(), t.getMonth(), 1).getDay(),
      o = (t) => {
  ...
  getDays(t = this.getMonthInfo(), e = this.minWeeks) {
    e = e > 10 ? 10 : e;
    const { start: i, length: o, previous: s, next: n } = t,
      r = [];
    let a = 1 - i;
    for (; a < o + 1 || r.length < e || r[r.length - 1].length % 7 != 0; ) {
      const { month: e, year: i } = a < 1 ? s : a > o ? n : t,
        l = a < 1 ? s.length + a : a > o ? a - o : a,
        c = `${e}-${l}-${i}`,
        h = {
          day: l,
          month: e,
  ...
  dateInString(t, e) {
    ...
    return (
      (t = "string" == typeof t ? t : `${t.getMonth() + 1}-${t.getDate()}-${t.getFullYear()}`), i.some((e) => e === t)
    );
  }
  getDayClassNames(t, e) {
    const { day: i, month: o, year: s, disabled: n, selected: r } = t;
    return ["day", e === `${o}-${i}-${s}` && "today", this.month !== o && "inactive", n && "disabled", r && "selected"]
      .filter(Boolean)
      .join(" ");
  }
  getWeekdayText() {
...
Kt([st({ mode: "boolean" })], mi.prototype, "readonly", void 0),
  Kt([st], mi.prototype, "locale", void 0),
  Kt([st({ converter: it })], mi.prototype, "month", void 0),
  Kt([st({ converter: it })], mi.prototype, "year", void 0),
  Kt([st({ attribute: "day-format", mode: "fromView" })], mi.prototype, "dayFormat", void 0),
  Kt([st({ attribute: "weekday-format", mode: "fromView" })], mi.prototype, "weekdayFormat", void 0),
  Kt([st({ attribute: "month-format", mode: "fromView" })], mi.prototype, "monthFormat", void 0),
  Kt([st({ attribute: "year-format", mode: "fromView" })], mi.prototype, "yearFormat", void 0),
  Kt([st({ attribute: "min-weeks", converter: it })], mi.prototype, "minWeeks", void 0),
  Kt([st({ attribute: "disabled-dates" })], mi.prototype, "disabledDates", void 0),
  Kt([st({ attribute: "selected-dates" })], mi.prototype, "selectedDates", void 0);
const vi = "none",
  bi = "default",
  yi = "sticky",
  xi = "default",
...
class Fi extends Ee {
  ...
  connectedCallback() {
    super.connectedCallback(),
      null === this.cellsRepeatBehavior &&
        ...
        this.updateItemTemplate(),
        (this.cellsRepeatBehavior = new Lt(
  ...
  updateItemTemplate() {
    this.activeCellItemTemplate =
      this.rowType === ki && void 0 !== this.cellItemTemplate
...
Kt([st({ attribute: "grid-template-columns" })], Fi.prototype, "gridTemplateColumns", void 0),
  Kt([st({ attribute: "row-type" })], Fi.prototype, "rowType", void 0),
  Kt([f], Fi.prototype, "rowData", void 0),
  Kt([f], Fi.prototype, "columnDefinitions", void 0),
  Kt([f], Fi.prototype, "cellItemTemplate", void 0),
  Kt([f], Fi.prototype, "headerCellItemTemplate", void 0),
  Kt([f], Fi.prototype, "rowIndex", void 0),
  Kt([f], Fi.prototype, "isActiveRow", void 0),
  Kt([f], Fi.prototype, "activeCellItemTemplate", void 0),
  Kt([f], Fi.prototype, "defaultCellItemTemplate", void 0),
  Kt([f], Fi.prototype, "defaultHeaderCellItemTemplate", void 0),
  Kt([f], Fi.prototype, "cellElements", void 0);
class Di extends Ee {
  constructor() {
    super(),
      (this.noTabbing = !1),
      (this.generateHeader = bi),
      (this.rowsData = []),
      (this.columnDefinitions = null),
      ...
      (this.focusOnCell = (t, e, i) => {
        ...
        i &&
          ...
          ((o < this.focusRowIndex && this.scrollTop > 0) ||
            (o > this.focusRowIndex && this.scrollTop < this.scrollHeight - this.clientHeight)) &&
      ...
      (this.updateRowIndexes = () => {
        ...
        this.rowElements.forEach((e, i) => {
          ...
          (o.rowIndex = i),
            ...
            this.columnDefinitionsStale && (o.columnDefinitions = this.columnDefinitions);
        }),
          (this.rowindexUpdateQueued = !1),
  ...
  rowsDataChanged() {
    null === this.columnDefinitions &&
      ...
      (this.columnDefinitions = Di.generateColumns(this.rowsData[0])),
      this.$fastController.isConnected && this.toggleGeneratedHeader();
  }
  columnDefinitionsChanged() {
    null !== this.columnDefinitions
      ? ((this.generatedGridTemplateColumns = Di.generateTemplateColumns(this.columnDefinitions)),
  ...
  connectedCallback() {
    super.connectedCallback(),
      ...
      (this.rowsRepeatBehavior = new Lt(
        (t) => t.rowsData,
        (t) => t.rowItemTemplate,
        { positioning: !0 },
      ...
      d.queueUpdate(this.queueRowIndexUpdate);
  }
  disconnectedCallback() {
    super.disconnectedCallback(),
  ...
  handleKeydown(t) {
    ...
    switch (t.key) {
      ...
      case "PageDown":
        ...
        for (e = this.focusRowIndex + 1; e <= i; e++) {
          ...
          if (t.offsetTop + t.offsetHeight > o) {
            let e = 0;
            this.generateHeader === yi && null !== this.generatedHeader && (e = this.generatedHeader.clientHeight),
      ...
      case "End":
        t.ctrlKey &&
          null !== this.columnDefinitions &&
          (t.preventDefault(), this.focusOnCell(this.rowElements.length - 1, this.columnDefinitions.length - 1, !0));
    }
  }
  queueFocusUpdate() {
    (this.isUpdatingFocus && (this.contains(document.activeElement) || this === document.activeElement)) ||
      (!1 === this.pendingFocusUpdate && ((this.pendingFocusUpdate = !0), d.queueUpdate(() => this.updateFocus())));
  }
  updateFocus() {
  ...
  toggleGeneratedHeader() {
    if (
      (null !== this.generatedHeader && (this.removeChild(this.generatedHeader), (this.generatedHeader = null)),
      this.generateHeader !== vi && this.rowsData.length > 0)
    ) {
      ...
      return (
        ...
        (this.generatedHeader.rowType = this.generateHeader === yi ? Ii : Ci),
        void (
...
(Di.generateColumns = (t) => Object.getOwnPropertyNames(t).map((t, e) => ({ columnDataKey: t, gridColumn: "" + e }))),
  Kt([st({ attribute: "no-tabbing", mode: "boolean" })], Di.prototype, "noTabbing", void 0),
  Kt([st({ attribute: "generate-header" })], Di.prototype, "generateHeader", void 0),
  Kt([st({ attribute: "grid-template-columns" })], Di.prototype, "gridTemplateColumns", void 0),
  Kt([f], Di.prototype, "rowsData", void 0),
  Kt([f], Di.prototype, "columnDefinitions", void 0),
  Kt([f], Di.prototype, "rowItemTemplate", void 0),
  Kt([f], Di.prototype, "cellItemTemplate", void 0),
  Kt([f], Di.prototype, "headerCellItemTemplate", void 0),
  Kt([f], Di.prototype, "focusRowIndex", void 0),
  Kt([f], Di.prototype, "focusColumnIndex", void 0),
  Kt([f], Di.prototype, "defaultRowItemTemplate", void 0),
  Kt([f], Di.prototype, "rowElementTag", void 0),
  Kt([f], Di.prototype, "rowElements", void 0);
const Ti = _`<template>${(t) =>
    null === t.rowData || null === t.columnDefinition || null === t.columnDefinition.columnDataKey
      ? null
  ...
  connectedCallback() {
    ...
    super.connectedCallback(),
      ...
      (this.style.gridColumn =
        "" +
        (void 0 === (null === (t = this.columnDefinition) || void 0 === t ? void 0 : t.gridColumn)
          ? 0
      ...
      switch (((this.isActiveCell = !0), this.cellType)) {
        case $i:
          if (
            ...
            "function" == typeof this.columnDefinition.headerCellFocusTargetCallback
          ) {
  ...
  handleKeydown(t) {
    if (
      !(
        t.defaultPrevented ||
        null === this.columnDefinition ||
        (this.cellType === xi && !0 !== this.columnDefinition.cellInternalFocusQueue) ||
        (this.cellType === $i && !0 !== this.columnDefinition.headerCellInternalFocusQueue)
      )
    )
      switch (t.key) {
        case "Enter":
      ...
      switch (this.cellType) {
        case $i:
          void 0 !== this.columnDefinition.headerCellTemplate
            ...
            : (this.customCellView = Si.render(this, this));
          break;
        case void 0:
        case wi:
        case xi:
          void 0 !== this.columnDefinition.cellTemplate
            ...
            : (this.customCellView = Ti.render(this, this));
      }
  }
  disconnectCellView() {
...
Kt([st({ attribute: "cell-type" })], Oi.prototype, "cellType", void 0),
  Kt([st({ attribute: "grid-column" })], Oi.prototype, "gridColumn", void 0),
  Kt([f], Oi.prototype, "rowData", void 0),
  Kt([f], Oi.prototype, "columnDefinition", void 0);
const Ei = _`<div class="title" part="title" aria-label="${(t) =>
    t.dateFormatter.getDate(`${t.month}-2-${t.year}`, { month: "long", year: "numeric" })}"><span part="month">${(t) =>
    t.dateFormatter.getMonth(t.month)}</span><span part="year">${(t) => t.dateFormatter.getYear(t.year)}</span></div>`,
  Vi = (t, e) => {
    const i = t.tagFor(Fi);
    return _`<${i} class="week" part="week" role="row" role-type="default" grid-template-columns="1fr 1fr 1fr 1fr 1fr 1fr 1fr">${Pt(
      (t) => t,
      ((t, e) => {
        const i = t.tagFor(Oi);
        return _`<${i} class="${(t, i) =>
          i.parentContext.parent.getDayClassNames(t, e)}" part="day" tabindex="-1" role="gridcell" grid-column="${(
          t,
          e,
        ) => e.index + 1}" @click="${(t, e) => e.parentContext.parent.handleDateSelect(e.event, t)}" @keydown="${(
          t,
          e,
        ) => e.parentContext.parent.handleKeydown(e.event, t)}" aria-label="${(t, e) =>
          e.parentContext.parent.dateFormatter.getDate(`${t.month}-${t.day}-${t.year}`, {
            month: "long",
            day: "numeric",
          })}"><div class="date" part="${(t) => (e === `${t.month}-${t.day}-${t.year}` ? "today" : "date")}">${(t, e) =>
          e.parentContext.parent.dateFormatter.getDay(t.day)}</div><slot name="${(t) => t.month}-${(t) => t.day}-${(
          t,
        ) => t.year}"></slot></${i}>`;
      })(t, e),
      { positioning: !0 },
  ...
  Ri = (t, e) => {
    const i = t.tagFor(Di),
      o = t.tagFor(Fi);
    return _`<${i} class="days interact" part="days" generate-header="none"><${o} class="week-days" part="week-days" role="row" row-type="header" grid-template-columns="1fr 1fr 1fr 1fr 1fr 1fr 1fr">${Pt(
      (t) => t.getWeekdayText(),
      ((t) => {
        const e = t.tagFor(Oi);
        return _`<${e} class="week-day" part="week-day" tabindex="-1" grid-column="${(t, e) => e.index + 1}" abbr="${(
          t,
        ) => t.abbr}">${(t) => t.text}</${e}>`;
      })(t),
      { positioning: !0 },
    )}</${o}>${Pt((t) => t.getDays(), Vi(t, e))}</${i}>`;
  };
class Ai extends Ee {}
class Li extends Ee {}
...
Kt([st({ attribute: "readonly", mode: "boolean" })], zi.prototype, "readOnly", void 0),
  Kt([f], zi.prototype, "defaultSlottedNodes", void 0),
  Kt([f], zi.prototype, "indeterminate", void 0);
class Mi extends Ee {
  constructor(t, e, i, o) {
    super(),
  ...
  contentChanged(t, e) {
    this.proxy instanceof HTMLOptionElement && (this.proxy.textContent = this.textContent),
      this.$emit("contentchange", null, { bubbles: !0 });
  }
  ...
  get text() {
    var t, e;
    return null !== (e = null === (t = this.textContent) || void 0 === t ? void 0 : t.replace(/\s+/g, " ").trim()) &&
      void 0 !== e
      ? e
      : "";
  }
...
Kt([f], Mi.prototype, "checked", void 0),
  Kt([f], Mi.prototype, "content", void 0),
  Kt([f], Mi.prototype, "defaultSelected", void 0),
  Kt([st({ mode: "boolean" })], Mi.prototype, "disabled", void 0),
  Kt([st({ attribute: "selected", mode: "boolean" })], Mi.prototype, "selectedAttribute", void 0),
  Kt([f], Mi.prototype, "selected", void 0),
  Kt([st({ attribute: "value", mode: "fromView" })], Mi.prototype, "initialValue", void 0);
class Bi {}
Kt([f], Bi.prototype, "ariaChecked", void 0),
  Kt([f], Bi.prototype, "ariaPosInSet", void 0),
  Kt([f], Bi.prototype, "ariaSelected", void 0),
  Kt([f], Bi.prototype, "ariaSetSize", void 0),
  Ae(Bi, Je),
  Ae(Mi, Ut, Bi);
class Ni extends Ee {
  constructor() {
  ...
  handleTypeAhead(t) {
    this.typeaheadTimeout && window.clearTimeout(this.typeaheadTimeout),
      (this.typeaheadTimeout = window.setTimeout(() => (this.typeaheadExpired = !0), Ni.TYPE_AHEAD_TIMEOUT_MS)),
  ...
  selectedIndexChanged(t, e) {
    ...
    if (this.hasSelectableOptions) {
      if (
        (null === (i = this.options[this.selectedIndex]) || void 0 === i ? void 0 : i.disabled) &&
        "number" == typeof t
      ) {
  ...
  selectFirstOption() {
    ...
    this.disabled ||
      (this.selectedIndex =
        null !== (e = null === (t = this.options) || void 0 === t ? void 0 : t.findIndex((t) => !t.disabled)) &&
        void 0 !== e
          ? e
          : -1);
  }
  selectLastOption() {
    this.disabled ||
      (this.selectedIndex = (function (t, e) {
        let i = t.length;
  ...
  setDefaultSelectedOption() {
    var t, e;
    this.selectedIndex =
      null !== (e = null === (t = this.options) || void 0 === t ? void 0 : t.findIndex((t) => t.defaultSelected)) &&
      void 0 !== e
        ? e
        : -1;
  }
  setSelectedOptions() {
    var t, e, i;
    (null === (t = this.options) || void 0 === t ? void 0 : t.length) &&
      ((this.selectedOptions = [this.options[this.selectedIndex]]),
      (this.ariaActiveDescendant =
        null !== (i = null === (e = this.firstSelectedOption) || void 0 === e ? void 0 : e.id) && void 0 !== i
          ? i
          : ""),
...
(Ni.slottedOptionFilter = (t) => Hi(t) && !t.hidden),
  (Ni.TYPE_AHEAD_TIMEOUT_MS = 1e3),
  Kt([st({ mode: "boolean" })], Ni.prototype, "disabled", void 0),
  Kt([f], Ni.prototype, "selectedIndex", void 0),
  Kt([f], Ni.prototype, "selectedOptions", void 0),
  Kt([f], Ni.prototype, "slottedOptions", void 0),
  Kt([f], Ni.prototype, "typeaheadBuffer", void 0);
class ji {}
Kt([f], ji.prototype, "ariaActiveDescendant", void 0),
  Kt([f], ji.prototype, "ariaDisabled", void 0),
  Kt([f], ji.prototype, "ariaExpanded", void 0),
  Kt([f], ji.prototype, "ariaMultiSelectable", void 0),
  Ae(ji, Je),
  Ae(Ni, ji);
const Ui = "above",
  qi = "below";
...
class Qi extends Gi {
  ...
  set value(t) {
    ...
    if (this.$fastController.isConnected && this.options) {
      ...
      (this.selectedIndex = n !== r ? s : this.selectedIndex),
        (t = (null === (o = this.firstSelectedOption) || void 0 === o ? void 0 : o.text) || t);
    }
  ...
  filterOptions() {
    ...
    (this.filteredOptions = this._options.filter((t) => t.text.toLowerCase().startsWith(this.filter.toLowerCase()))),
  ...
  inputHandler(t) {
    if (
      ...
      this.filterOptions(),
      this.isAutocompleteInline || (this.selectedIndex = this.options.map((t) => t.text).indexOf(this.control.value)),
      t.inputType.includes("deleteContent") || !this.filter.length)
    )
      return !0;
    ...
    switch (e) {
      ...
      case "ArrowDown":
        ...
        this.filteredOptions.length > 0 && super.keydownHandler(t),
          this.isAutocompleteInline && this.setInlineSelection();
        break;
      default:
        return !0;
    }
  ...
  setDefaultSelectedOption() {
    if (this.$fastController.isConnected && this.options) {
      ...
      (this.selectedIndex = t),
        !this.dirtyValue && this.firstSelectedOption && (this.value = this.firstSelectedOption.text),
        this.setSelectedOptions();
    }
  }
  setInputToSelection() {
  ...
  syncValue() {
    ...
    const e =
      this.selectedIndex > -1
        ? null === (t = this.firstSelectedOption) || void 0 === t
          ? void 0
          : t.text
        : this.control.value;
  ...
  setPositioning() {
    ...
    (this.position = this.forcedPosition ? this.positionAttribute : t.top > e ? Ui : qi),
      (this.positionAttribute = this.forcedPosition ? this.positionAttribute : this.position),
      (this.maxHeight = this.position === Ui ? ~~t.top : ~~e);
  }
  selectedOptionsChanged(t, e) {
    this.$fastController.isConnected &&
      this._options.forEach((t) => {
  ...
  updateValue(t) {
    var e;
    this.$fastController.isConnected &&
      ((this.value = (null === (e = this.firstSelectedOption) || void 0 === e ? void 0 : e.text) || this.control.value),
...
Kt([st({ attribute: "autocomplete", mode: "fromView" })], Qi.prototype, "autocomplete", void 0),
  Kt([f], Qi.prototype, "maxHeight", void 0),
  Kt([st({ attribute: "open", mode: "boolean" })], Qi.prototype, "open", void 0),
  Kt([st], Qi.prototype, "placeholder", void 0),
  Kt([st({ attribute: "position" })], Qi.prototype, "positionAttribute", void 0),
  Kt([f], Qi.prototype, "position", void 0);
class Zi {}
Kt([f], Zi.prototype, "ariaAutoComplete", void 0),
  Kt([f], Zi.prototype, "ariaControls", void 0),
  Ae(Zi, ji),
  Ae(Qi, Ut, Zi);
function Ji(t) {
...
class so {
  constructor(t) {
    ...
    (this.style = document.createElement("style")),
      ...
      g.getNotifier(e).subscribe(this, "isConnected"),
...
const ao = new WeakMap(),
  lo = d.supportsAdoptedStyleSheets
    ? class extends eo {
        constructor(t) {
          super();
    ...
    getOrCreate(t) {
      ...
      return (
        t === to
          ...
          ? (e = d.supportsAdoptedStyleSheets ? new io() : new oo())
          : (e = t instanceof gt ? new lo(t) : new no(t)),
        ao.set(t, e),
        e
      );
    },
  ...
  constructor(t) {
    super(),
      ...
      null !== t.cssCustomPropertyName &&
        ((this.cssCustomProperty = "--" + t.cssCustomPropertyName), (this.cssVar = `var(${this.cssCustomProperty})`)),
      (this.id = ho.uniqueId()),
      ho.tokensById.set(this.id, this);
  }
  get appliedTo() {
  ...
  static from(t) {
    return new ho({
      ...
      cssCustomPropertyName:
        "string" == typeof t ? t : void 0 === t.cssCustomPropertyName ? t.name : t.cssCustomPropertyName,
    });
  }
...
class uo {
  constructor(t, e, i) {
    (this.source = t),
      ...
      (this.observer = g.binding(t, this, !1)),
...
class mo {
  constructor(t) {
    (this.target = t),
      ...
      go.set(t, this),
      g.getNotifier(this.store).subscribe(this.tokenValueChangeHandler),
      t instanceof gt ? t.$fastController.addBehaviors([this]) : t.isConnected && this.bind();
  }
  ...
  getRaw(t) {
    var e;
    return this.assignedValues.has(t)
      ? this.assignedValues.get(t)
      : null === (e = mo.findClosestAssignedNode(t, this)) || void 0 === e
      ? void 0
      : e.getRaw(t);
  }
  set(t, e) {
    ho.isDerivedDesignTokenValue(this.assignedValues.get(t)) && this.tearDownBindingObserver(t),
      this.assignedValues.set(t, e),
      ho.isDerivedDesignTokenValue(e) ? this.setupBindingObserver(t, e) : this.store.set(t, e);
  }
  delete(t) {
  ...
  removeChild(t) {
    ...
    return (
      ...
      g.getNotifier(this.store).unsubscribe(t),
      t.parent === this && fo.delete(t)
    );
  }
  contains(t) {
    return (function (t, e) {
  ...
  hydrate(t, e) {
    if (!this.has(t)) {
      ...
      ho.isDerivedDesignTokenValue(e)
        ? i
          ? i.source !== e && (this.tearDownBindingObserver(t), this.setupBindingObserver(t, e))
          : this.setupBindingObserver(t, e)
        : (i && this.tearDownBindingObserver(t), this.store.set(t, e));
    }
  }
  ...
  tearDownBindingObserver(t) {
    return (
      !!this.bindingObservers.has(t) && (this.bindingObservers.get(t).disconnect(), this.bindingObservers.delete(t), !0)
    );
  }
}
...
const vo = Object.freeze({
  ...
  bo = Object.freeze({ definitionCallbackOnly: null, ignoreDuplicate: Symbol() }),
  yo = new Map(),
  xo = new Map();
let $o = null;
...
class Co {
  constructor(t, e) {
    (this.owner = t),
      ...
      (this.disambiguate = () => bo.definitionCallbackOnly),
      ...
      n = {
        ...
        tryDefineElement(t, n, r) {
          const a = (function (t, e, i) {
            ...
            { name: l, callback: c, baseClass: h } = a;
          let { type: d } = a,
            u = l,
            p = yo.get(u),
            g = !0;
          ...
          g && ((xo.has(d) || d === Ee) && (d = class extends d {}), yo.set(u, d), xo.set(d, u), h && xo.set(h, u)),
            i.push(new Io(e, u, d, s, c, g));
        },
      };
    this.designTokensInitialized ||
      ((this.designTokensInitialized = !0), null !== this.designTokenRoot && vo.registerRoot(this.designTokenRoot)),
      e.registerWithContext(n, ...t);
      ...
      (function (t) {
        ...
        return isNaN(e)
          ? (function (t) {
            ...
            ? 0
            : ("AUDIO" !== t.nodeName && "VIDEO" !== t.nodeName && "DETAILS" !== t.nodeName) ||
...
class Po extends Ee {
        ...
        return 0 !== e.length
          ? 1 === e.length
            ...
            : void (t.shiftKey && t.target === e[0]
                ...
                : t.shiftKey || t.target !== e[e.length - 1] || (e[0].focus(), t.preventDefault()))
          : void 0;
      }),
      (this.getTabQueueBounds = () => Po.reduceTabbableItems([], this)),
      ...
      (this.updateTrapFocus = (t) => {
        ...
        e && !this.isTrappingFocus
          ...
          : !e &&
            ...
            ((this.isTrappingFocus = !1), document.removeEventListener("focusin", this.handleDocumentFocus));
      });
  }
  dismiss() {
  ...
  connectedCallback() {
    super.connectedCallback(),
      ...
      (this.notifier = g.getNotifier(this)),
  ...
  static reduceTabbableItems(t, e) {
    return "-1" === e.getAttribute("tabindex")
      ? t
      : Ro(e) || (Po.isFocusableFastElement(e) && Po.hasTabbableShadow(e))
      ? (t.push(e), t)
      : e.childElementCount
      ? t.concat(Array.from(e.children).reduce(Po.reduceTabbableItems, []))
      : t;
  }
  static isFocusableFastElement(t) {
    var e, i;
    return !!(null === (i = null === (e = t.$fastController) || void 0 === e ? void 0 : e.definition.shadowOptions) ||
    void 0 === i
      ? void 0
      : i.delegatesFocus);
  }
  static hasTabbableShadow(t) {
    var e, i;
    return Array.from(
      null !== (i = null === (e = t.shadowRoot) || void 0 === e ? void 0 : e.querySelectorAll("*")) && void 0 !== i
        ? i
        : [],
    ).some((t) => Ro(t));
  }
}
Kt([st({ mode: "boolean" })], Po.prototype, "modal", void 0),
  Kt([st({ mode: "boolean" })], Po.prototype, "hidden", void 0),
  Kt([st({ attribute: "trap-focus", mode: "boolean" })], Po.prototype, "trapFocus", void 0),
  Kt([st({ attribute: "aria-describedby" })], Po.prototype, "ariaDescribedby", void 0),
  Kt([st({ attribute: "aria-labelledby" })], Po.prototype, "ariaLabelledby", void 0),
  Kt([st({ attribute: "aria-label" })], Po.prototype, "ariaLabel", void 0);
const zo = "separator";
class Ho extends Ee {
  constructor() {
...
Kt([st({ mode: "boolean" })], No.prototype, "disabled", void 0),
  Kt([st({ attribute: "aria-hidden", converter: et })], No.prototype, "hiddenFromAT", void 0),
  Kt([st], No.prototype, "direction", void 0);
class jo extends Ni {
  constructor() {
  ...
  activeIndexChanged(t, e) {
    var i, o;
    (this.ariaActiveDescendant =
      null !== (o = null === (i = this.options[e]) || void 0 === i ? void 0 : i.id) && void 0 !== o ? o : ""),
      this.focusAndScrollOptionIntoView();
  }
  checkActiveIndex() {
  ...
  checkFirstOption(t = !1) {
    t
      ? (-1 === this.rangeStartIndex && (this.rangeStartIndex = this.activeIndex + 1),
        this.options.forEach((t, e) => {
  ...
  checkLastOption(t = !1) {
    t
      ? (-1 === this.rangeStartIndex && (this.rangeStartIndex = this.activeIndex),
        this.options.forEach((t, e) => {
  ...
  focusinHandler(t) {
    ...
    this.shouldSkipFocus ||
      ...
      (this.uncheckAllOptions(),
      -1 === this.activeIndex &&
        (this.activeIndex = -1 !== this.firstSelectedOptionIndex ? this.firstSelectedOptionIndex : 0),
      this.checkActiveIndex(),
      this.setSelectedOptions(),
      this.focusAndScrollOptionIntoView()),
      (this.shouldSkipFocus = !1);
  ...
  setSelectedOptions() {
    this.multiple
      ? this.$fastController.isConnected &&
        this.options &&
        ((this.selectedOptions = this.options.filter((t) => t.selected)), this.focusAndScrollOptionIntoView())
  ...
  typeaheadBufferChanged(t, e) {
    if (this.multiple) {
      if (this.$fastController.isConnected) {
        ...
        e > -1 && ((this.activeIndex = e), this.uncheckAllOptions(), this.checkActiveIndex()),
          (this.typeAheadExpired = !1);
      }
...
Kt([f], jo.prototype, "activeIndex", void 0),
  Kt([st({ mode: "boolean" })], jo.prototype, "multiple", void 0),
  Kt([st({ converter: it })], jo.prototype, "size", void 0);
const Uo = "menuitem",
  qo = "menuitemcheckbox",
  _o = "menuitemradio",
...
class Wo extends Ee {
  constructor() {
    super(...arguments),
      ...
      (this.handleMenuItemClick = (t) => (t.defaultPrevented || this.disabled || this.invoke(), !1)),
      (this.submenuLoaded = () => {
        this.focusSubmenuOnLoad &&
          ((this.focusSubmenuOnLoad = !1),
          this.hasSubmenu && (this.submenu.focus(), this.setAttribute("tabindex", "-1")));
      }),
      (this.handleMouseOver = (t) => (this.disabled || !this.hasSubmenu || this.expanded || (this.expanded = !0), !1)),
      (this.handleMouseOut = (t) => (
        !this.expanded || this.contains(document.activeElement) || (this.expanded = !1), !1
      )),
      (this.expandAndFocus = () => {
  ...
  expandedChanged(t) {
    if (this.$fastController.isConnected) {
      ...
      !1 === this.expanded ? this.submenu.collapseExpandedItem() : (this.currentDirection = ii(this)),
...
Kt([st({ mode: "boolean" })], Wo.prototype, "disabled", void 0),
  Kt([st({ mode: "boolean" })], Wo.prototype, "expanded", void 0),
  Kt([f], Wo.prototype, "startColumnCount", void 0),
  Kt([st], Wo.prototype, "role", void 0),
  Kt([st({ mode: "boolean" })], Wo.prototype, "checked", void 0),
  Kt([f], Wo.prototype, "submenuRegion", void 0),
  Kt([f], Wo.prototype, "hasSubmenu", void 0),
  Kt([f], Wo.prototype, "currentDirection", void 0),
  Kt([f], Wo.prototype, "submenu", void 0),
  Ae(Wo, Ut);
class Ko extends Ee {
  constructor() {
    super(...arguments),
      ...
      (this.handleExpandedChanged = (t) => {
        ...
        t.preventDefault();
        const e = t.target;
        null === this.expandedItem || e !== this.expandedItem || !1 !== e.expanded
          ? e.expanded &&
            (null !== this.expandedItem && this.expandedItem !== e && (this.expandedItem.expanded = !1),
            this.menuItems[this.focusIndex].setAttribute("tabindex", "-1"),
            (this.expandedItem = e),
            (this.focusIndex = this.menuItems.indexOf(e)),
            e.setAttribute("tabindex", "0"))
      ...
      (this.setItems = () => {
        ...
        e.forEach((t, e) => {
          t.setAttribute("tabindex", 0 === e ? "0" : "-1"),
            ...
            t.addEventListener("focus", this.handleItemFocus),
            t instanceof Wo && (t.startColumnCount = i);
        });
      }),
      ...
      (this.isMenuItemElement = (t) => He(t) && Ko.focusableElementRoles.hasOwnProperty(t.getAttribute("role"))),
...
Kt([st({ attribute: "readonly", mode: "boolean" })], Zo.prototype, "readOnly", void 0),
  Kt([st({ mode: "boolean" })], Zo.prototype, "autofocus", void 0),
  Kt([st], Zo.prototype, "placeholder", void 0),
  Kt([st], Zo.prototype, "type", void 0),
  Kt([st], Zo.prototype, "list", void 0),
  Kt([st({ converter: it })], Zo.prototype, "maxlength", void 0),
  Kt([st({ converter: it })], Zo.prototype, "minlength", void 0),
  Kt([st], Zo.prototype, "pattern", void 0),
  Kt([st({ converter: it })], Zo.prototype, "size", void 0),
  Kt([st({ mode: "boolean" })], Zo.prototype, "spellcheck", void 0),
  Kt([f], Zo.prototype, "defaultSlottedNodes", void 0);
class Jo {}
...
class is extends es {
  ...
  valueChanged(t, e) {
    (this.value = this.getValidValue(e)),
      e === this.value &&
        (this.control && !this.isUserInput && (this.control.value = this.value),
        super.valueChanged(t, this.value),
        void 0 === t || this.isUserInput || (this.$emit("input"), this.$emit("change")),
        (this.isUserInput = !1));
  }
  validate() {
    super.validate(this.control);
  ...
  getValidValue(t) {
    ...
    return (
      isNaN(o)
        ? (o = "")
        : ((o = Math.min(o, null !== (e = this.max) && void 0 !== e ? e : o)),
          (o = Math.max(o, null !== (i = this.min) && void 0 !== i ? i : o).toString())),
      o
    );
  }
  stepUp() {
...
Kt([st({ attribute: "readonly", mode: "boolean" })], is.prototype, "readOnly", void 0),
  Kt([st({ mode: "boolean" })], is.prototype, "autofocus", void 0),
  Kt([st({ attribute: "hide-step", mode: "boolean" })], is.prototype, "hideStep", void 0),
  Kt([st], is.prototype, "placeholder", void 0),
  Kt([st], is.prototype, "list", void 0),
  Kt([st({ converter: it })], is.prototype, "maxlength", void 0),
  Kt([st({ converter: it })], is.prototype, "minlength", void 0),
  Kt([st({ converter: it })], is.prototype, "size", void 0),
  Kt([st({ converter: it })], is.prototype, "step", void 0),
  Kt([st({ converter: it })], is.prototype, "max", void 0),
  Kt([st({ converter: it })], is.prototype, "min", void 0),
  Kt([f], is.prototype, "defaultSlottedNodes", void 0),
  Ae(is, Ut, Jo);
class os extends Ee {
  constructor() {
...
Kt([st({ converter: it })], os.prototype, "value", void 0),
  Kt([st({ converter: it })], os.prototype, "min", void 0),
  Kt([st({ converter: it })], os.prototype, "max", void 0),
  Kt([st({ mode: "boolean" })], os.prototype, "paused", void 0),
  Kt([f], os.prototype, "percentComplete", void 0);
class ss extends Ee {
  constructor() {
    super(...arguments),
      (this.orientation = Pe),
      ...
      (this.shouldMoveOffGroupToTheRight = (t, e, i) => t === e.length && this.isInsideToolbar && "ArrowRight" === i),
      (this.shouldMoveOffGroupToTheLeft = (t, e) =>
        (this.focusedRadio ? t.indexOf(this.focusedRadio) - 1 : 0) < 0 && this.isInsideToolbar && "ArrowLeft" === e),
        ...
        void 0 !== this.name && t.setAttribute("name", this.name),
          ...
          this.value && this.value === t.value
            ? ((this.selectedRadio = t),
              ...
              (i = !0))
            : (this.isInsideFoundationToolbar || t.setAttribute("tabindex", "-1"), (t.checked = !1)),
...
Kt([st({ attribute: "readonly", mode: "boolean" })], ss.prototype, "readOnly", void 0),
  Kt([st({ attribute: "disabled", mode: "boolean" })], ss.prototype, "disabled", void 0),
  Kt([st], ss.prototype, "name", void 0),
  Kt([st], ss.prototype, "value", void 0),
  Kt([st], ss.prototype, "orientation", void 0),
  Kt([f], ss.prototype, "childItems", void 0),
  Kt([f], ss.prototype, "slottedRadioButtons", void 0);
class ns extends Ee {}
  ...
  defaultCheckedChanged() {
    ...
    this.$fastController.isConnected &&
      ...
      (this.isInsideRadioGroup() ||
        ((this.checked = null !== (t = this.defaultChecked) && void 0 !== t && t), (this.dirtyChecked = !1)));
  }
  connectedCallback() {
    var t, e;
    super.connectedCallback(),
      this.validate(),
      "radiogroup" !== (null === (t = this.parentElement) || void 0 === t ? void 0 : t.getAttribute("role")) &&
        null === this.getAttribute("tabindex") &&
        (this.disabled || this.setAttribute("tabindex", "0")),
      this.checkedAttribute &&
        (this.dirtyChecked ||
          this.isInsideRadioGroup() ||
          ((this.checked = null !== (e = this.defaultChecked) && void 0 !== e && e), (this.dirtyChecked = !1)));
  }
  isInsideRadioGroup() {
...
Kt([st({ attribute: "readonly", mode: "boolean" })], as.prototype, "readOnly", void 0),
  Kt([f], as.prototype, "name", void 0),
  Kt([f], as.prototype, "defaultSlottedNodes", void 0);
class ls extends Ee {
  constructor() {
    super(...arguments),
  ...
  updateScrollStops() {
    ...
    const t = this.scrollItems.reduce(
      (t, e) => (e instanceof HTMLSlotElement ? t.concat(e.assignedElements()) : (t.push(e), t)),
      [],
    );
  ...
  setStops() {
    ...
    const { scrollContainer: t } = this,
      { scrollLeft: e } = t,
      { width: i, left: o } = t.getBoundingClientRect();
    this.width = i;
    let s = 0,
      n = this.scrollItems
        .map((t, i) => {
          const { left: n, width: r } = t.getBoundingClientRect(),
            a = Math.round(n + e - o),
            l = Math.round(a + r);
          return this.isRtl ? -l : ((s = l), 0 === i ? 0 : a);
        })
        .concat(s);
    (n = this.fixScrollMisalign(n)),
      n.sort((t, e) => Math.abs(t) - Math.abs(e)),
      (this.scrollStops = n),
      this.setFlippers();
  }
  validateStops(t = !0) {
  ...
  setFlippers() {
    ...
    if (
      (null === (t = this.previousFlipperContainer) || void 0 === t || t.classList.toggle("disabled", 0 === i),
      this.scrollStops)
    ) {
      const t = Math.abs(this.scrollStops[this.scrollStops.length - 1]);
      null === (e = this.nextFlipperContainer) ||
        void 0 === e ||
        e.classList.toggle("disabled", this.validateStops(!1) && Math.abs(i) + this.width >= t);
    }
  }
  scrollInView(t, e = 0, i) {
    var o;
    if (
      ("number" != typeof t && t && (t = this.scrollItems.findIndex((e) => e === t || e.contains(t))), void 0 !== t)
    ) {
      i = null != i ? i : e;
      const { scrollContainer: s, scrollStops: n, scrollItems: r } = this,
        { scrollLeft: a } = this.scrollContainer,
        { width: l } = s.getBoundingClientRect(),
        c = n[t],
      ...
      if (u || a + l - i < d) {
        const t =
          null !==
            (o = [...n]
              .sort((t, e) => (u ? e - t : t - e))
              .find((t) => (u ? t + e < c : t + l - (null != i ? i : 0) > d))) && void 0 !== o
            ? o
            : 0;
  ...
  scrollToPrevious() {
    ...
    const t = this.scrollContainer.scrollLeft,
      e = this.scrollStops.findIndex(
        (e, i) => e >= t && (this.isRtl || i === this.scrollStops.length - 1 || this.scrollStops[i + 1] > t),
      ),
  ...
  scrollToPosition(t, e = this.scrollContainer.scrollLeft) {
    ...
    const s = parseFloat(getComputedStyle(this.content).getPropertyValue("transition-duration")),
      n = (e) => {
        (e && e.target !== e.currentTarget) ||
          ...
          this.setFlippers(),
          this.content.removeEventListener("transitionend", n),
          (this.scrolling = !1));
      };
...
Kt([st({ converter: it })], ls.prototype, "speed", void 0),
  Kt([st], ls.prototype, "duration", void 0),
  Kt([st], ls.prototype, "easing", void 0),
  Kt([st({ attribute: "flippers-hidden-from-at", converter: et })], ls.prototype, "flippersHiddenFromAT", void 0),
  Kt([f], ls.prototype, "scrolling", void 0),
  Kt([f], ls.prototype, "scrollItems", void 0),
  Kt([st({ attribute: "view" })], ls.prototype, "view", void 0);
function cs(t, e, i) {
...
Kt([st({ attribute: "readonly", mode: "boolean" })], us.prototype, "readOnly", void 0),
  Kt([st({ mode: "boolean" })], us.prototype, "autofocus", void 0),
  Kt([st], us.prototype, "placeholder", void 0),
  Kt([st], us.prototype, "list", void 0),
  Kt([st({ converter: it })], us.prototype, "maxlength", void 0),
  Kt([st({ converter: it })], us.prototype, "minlength", void 0),
  Kt([st], us.prototype, "pattern", void 0),
  Kt([st({ converter: it })], us.prototype, "size", void 0),
  Kt([st({ mode: "boolean" })], us.prototype, "spellcheck", void 0),
  Kt([f], us.prototype, "defaultSlottedNodes", void 0);
class ps {}
...
class ms extends fs {
  ...
  set value(t) {
    ...
    if (null === (e = this._options) || void 0 === e ? void 0 : e.length) {
      const e = this._options.findIndex((e) => e.value === t),
        l =
          null !== (o = null === (i = this._options[this.selectedIndex]) || void 0 === i ? void 0 : i.value) &&
          void 0 !== o
            ? o
            : null,
        c =
          null !== (n = null === (s = this._options[e]) || void 0 === s ? void 0 : s.value) && void 0 !== n ? n : null;
      (-1 !== e && l === c) || ((t = ""), (this.selectedIndex = e)),
        (t =
          null !== (a = null === (r = this.firstSelectedOption) || void 0 === r ? void 0 : r.value) && void 0 !== a
            ? a
            : t);
    }
  ...
  updateValue(t) {
    ...
    this.$fastController.isConnected &&
      (this.value =
        null !== (i = null === (e = this.firstSelectedOption) || void 0 === e ? void 0 : e.value) && void 0 !== i
          ? i
          : ""),
      t && (this.$emit("input"), this.$emit("change", this, { bubbles: !0, composed: void 0 }));
  }
  selectedIndexChanged(t, e) {
  ...
  focusoutHandler(t) {
    ...
    this.isSameNode(i)
      ? this.focus()
      : (null === (e = this.options) || void 0 === e ? void 0 : e.includes(i)) ||
        ((this.open = !1), this.indexWhenOpened !== this.selectedIndex && this.updateValue(!0));
  }
  handleChange(t, e) {
  ...
  mousedownHandler(t) {
    var e;
    return t.offsetX >= 0 && t.offsetX <= (null === (e = this.listbox) || void 0 === e ? void 0 : e.scrollWidth)
      ? super.mousedownHandler(t)
      : this.collapsible;
  }
  multipleChanged(t, e) {
  ...
  setDefaultSelectedOption() {
    var t;
    const e =
        null !== (t = this.options) && void 0 !== t ? t : Array.from(this.children).filter(Ni.slottedOptionFilter),
...
Kt([st({ attribute: "open", mode: "boolean" })], ms.prototype, "open", void 0),
  Kt(
    [
      function (t, e, i) {
  ...
  Kt([f], ms.prototype, "control", void 0),
  Kt([st({ attribute: "position" })], ms.prototype, "positionAttribute", void 0),
  Kt([f], ms.prototype, "position", void 0),
  Kt([f], ms.prototype, "maxHeight", void 0);
class vs {}
...
Kt([st], bs.prototype, "fill", void 0),
  Kt([st], bs.prototype, "shape", void 0),
  Kt([st], bs.prototype, "pattern", void 0),
  Kt([st({ mode: "boolean" })], bs.prototype, "shimmer", void 0);
function ys(t, e, i, o) {
...
class $s extends Ee {
  constructor() {
    super(...arguments),
      (this.hideMark = !1),
      (this.sliderDirection = je.ltr),
      (this.getSliderConfiguration = () => {
        if (this.isSliderConfig(this.parentNode)) {
          const t = this.parentNode,
            { min: e, max: i, direction: o, orientation: s, disabled: n } = t;
          void 0 !== n && (this.disabled = n),
            (this.sliderDirection = o || je.ltr),
            (this.sliderOrientation = s || Pe),
            (this.sliderMaxPosition = i),
            (this.sliderMinPosition = e);
        } else
          (this.sliderDirection = xs.direction || je.ltr),
            (this.sliderOrientation = xs.orientation),
            (this.sliderMaxPosition = xs.max),
            (this.sliderMinPosition = xs.min);
      }),
      (this.positionAsStyle = () => {
        ...
        let i = Math.round(100 * (1 - e)),
          o = Math.round(100 * e);
        return (
          Number.isNaN(o) && Number.isNaN(i) && ((i = 50), (o = 50)),
          this.sliderOrientation === Pe
            ? t === je.rtl
              ? `right: ${o}%; left: ${i}%;`
              : `left: ${o}%; right: ${i}%;`
            : `top: ${o}%; bottom: ${i}%;`
...
Kt([f], $s.prototype, "positionStyle", void 0),
  Kt([st], $s.prototype, "position", void 0),
  Kt([st({ attribute: "hide-mark", mode: "boolean" })], $s.prototype, "hideMark", void 0),
  Kt([st({ attribute: "disabled", mode: "boolean" })], $s.prototype, "disabled", void 0),
  Kt([f], $s.prototype, "sliderOrientation", void 0),
  Kt([f], $s.prototype, "sliderMinPosition", void 0),
  Kt([f], $s.prototype, "sliderMaxPosition", void 0),
  Kt([f], $s.prototype, "sliderDirection", void 0);
class ws extends Ee {}
...
class Is extends ks {
  constructor() {
    super(...arguments),
      ...
      (this.keypressHandler = (t) => {
        if (!this.readOnly)
          if ("Home" === t.key) t.preventDefault(), (this.value = "" + this.min);
          else if ("End" === t.key) t.preventDefault(), (this.value = "" + this.max);
          else if (!t.shiftKey)
            switch (t.key) {
              case "ArrowRight":
              case "ArrowUp":
      ...
      (this.setupListeners = (t = !1) => {
        ...
        this[e]("keydown", this.keypressHandler),
          ...
          this.thumb[e]("mousedown", this.handleThumbMouseDown, { passive: !0 }),
          this.thumb[e]("touchstart", this.handleThumbMouseDown, { passive: !0 }),
      ...
      (this.handleThumbMouseDown = (t) => {
        ...
        window[e]("mouseup", this.handleWindowMouseUp),
          window[e]("mousemove", this.handleMouseMove, { passive: !0 }),
          window[e]("touchmove", this.handleMouseMove, { passive: !0 }),
      ...
      (this.calculateNewValue = (t) => {
        const e = ys(
            t,
            this.orientation === Pe ? this.trackMinWidth : this.trackMinHeight,
            this.orientation === Pe ? this.trackWidth : this.trackHeight,
            this.direction,
          ),
      ...
      (this.handleMouseDown = (t) => {
        const e = (null !== t ? "add" : "remove") + "EventListener";
        if (
          (null === t || (!this.disabled && !this.readOnly)) &&
          (window[e]("mouseup", this.handleWindowMouseUp),
  ...
  increment() {
    const t =
        this.direction !== je.rtl && this.orientation !== ze
  ...
  setThumbPositionForOrientation(t) {
    ...
    this.orientation === Pe
      ? (this.position = this.isDragging
          ? `right: ${e}%; transition: none;`
          : `right: ${e}%; transition: all 0.2s ease;`)
      : (this.position = this.isDragging
          ? `bottom: ${e}%; transition: none;`
...
Kt([st({ attribute: "readonly", mode: "boolean" })], Is.prototype, "readOnly", void 0),
  Kt([f], Is.prototype, "direction", void 0),
  Kt([f], Is.prototype, "isDragging", void 0),
  Kt([f], Is.prototype, "position", void 0),
  Kt([f], Is.prototype, "trackWidth", void 0),
  Kt([f], Is.prototype, "trackMinWidth", void 0),
  Kt([f], Is.prototype, "trackHeight", void 0),
  Kt([f], Is.prototype, "trackLeft", void 0),
  Kt([f], Is.prototype, "trackMinHeight", void 0),
  Kt([f], Is.prototype, "valueTextFormatter", void 0),
  Kt([st({ converter: it })], Is.prototype, "min", void 0),
  Kt([st({ converter: it })], Is.prototype, "max", void 0),
  Kt([st({ converter: it })], Is.prototype, "step", void 0),
  Kt([st], Is.prototype, "orientation", void 0),
  Kt([st], Is.prototype, "mode", void 0);
class Fs extends Ee {}
...
Kt([st({ attribute: "readonly", mode: "boolean" })], Ts.prototype, "readOnly", void 0),
  Kt([f], Ts.prototype, "defaultSlottedNodes", void 0);
class Ss extends Ee {}
class Os extends Ee {}
...
class Vs extends Ee {
  constructor() {
    super(...arguments),
        ...
        (this.activeTabIndex = this.getActiveIndex()),
          ...
          this.tabs.forEach((e, i) => {
            if ("tab" === e.slot) {
              ...
              const o = this.tabIds[i],
                s = this.tabpanelIds[i];
              e.setAttribute("id", o),
            ...
            (e.style.gridColumn = ""),
              (e.style.gridRow = ""),
              (e.style[t] = "" + (i + 1)),
              this.isHorizontal() ? e.classList.remove("vertical") : e.classList.add("vertical");
          });
      }),
      (this.setTabPanels = () => {
      ...
      (this.adjustForward = (t) => {
        ...
        let i = 0;
        for (
          i = this.activetab ? e.indexOf(this.activetab) + 1 : 1, i === e.length && (i = 0);
      ...
      (this.adjustBackward = (t) => {
        ...
        let i = 0;
        for (
          i = this.activetab ? e.indexOf(this.activetab) - 1 : 0, i = i < 0 ? e.length - 1 : i;
          i >= 0 && e.length > 1;
  ...
  activeidChanged(t, e) {
    this.$fastController.isConnected &&
      ...
      ((this.prevActiveTabIndex = this.tabs.findIndex((e) => e.id === t)),
      this.setTabs(),
      this.setTabPanels(),
  ...
  setComponent() {
    this.activeTabIndex !== this.prevActiveTabIndex &&
      ((this.activeid = this.tabIds[this.activeTabIndex]), this.focusTab(), this.change());
  }
  isHorizontal() {
  ...
  handleActiveIndicatorPosition() {
    this.showActiveIndicator &&
      ...
      this.activeTabIndex !== this.prevActiveTabIndex &&
      (this.ticking ? (this.ticking = !1) : ((this.ticking = !0), this.animateActiveIndicator()));
  }
  ...
  adjust(t) {
    (this.prevActiveTabIndex = this.activeTabIndex),
      (this.activeTabIndex = Ue(0, this.tabs.length - 1, this.activeTabIndex + t)),
      this.setComponent();
  }
  focusTab() {
...
Kt([st], Vs.prototype, "orientation", void 0),
  Kt([st], Vs.prototype, "activeid", void 0),
  Kt([f], Vs.prototype, "tabs", void 0),
  Kt([f], Vs.prototype, "tabpanels", void 0),
  Kt([st({ mode: "boolean" })], Vs.prototype, "activeindicator", void 0),
  Kt([f], Vs.prototype, "activeIndicatorRef", void 0),
  Kt([f], Vs.prototype, "showActiveIndicator", void 0),
  Ae(Vs, Ut);
class Rs extends Ee {}
...
Kt([st({ mode: "boolean" })], Ps.prototype, "readOnly", void 0),
  Kt([st], Ps.prototype, "resize", void 0),
  Kt([st({ mode: "boolean" })], Ps.prototype, "autofocus", void 0),
  Kt([st({ attribute: "form" })], Ps.prototype, "formId", void 0),
  Kt([st], Ps.prototype, "list", void 0),
  Kt([st({ converter: it })], Ps.prototype, "maxlength", void 0),
  Kt([st({ converter: it })], Ps.prototype, "minlength", void 0),
  Kt([st], Ps.prototype, "name", void 0),
  Kt([st], Ps.prototype, "placeholder", void 0),
  Kt([st({ converter: it, mode: "fromView" })], Ps.prototype, "cols", void 0),
  Kt([st({ converter: it, mode: "fromView" })], Ps.prototype, "rows", void 0),
  Kt([st({ mode: "boolean" })], Ps.prototype, "spellcheck", void 0),
  Kt([f], Ps.prototype, "defaultSlottedNodes", void 0),
  Ae(Ps, Jo);
...
class Hs extends Ee {
  ...
  set activeIndex(t) {
    this.$fastController.isConnected &&
      ((this._activeIndex = qe(0, this.focusableElements.length - 1, t)), g.notify(this, "activeIndex"));
  }
  slottedItemsChanged() {
  ...
  getDirectionalIncrementer(t) {
    ...
    return null !==
      (n =
        null !==
          (o =
            null === (i = null === (e = zs[t]) || void 0 === e ? void 0 : e[this.orientation]) || void 0 === i
              ? void 0
              : i[this.direction]) && void 0 !== o
          ? o
          : null === (s = zs[t]) || void 0 === s
          ? void 0
  ...
  static reduceFocusableItems(t, e) {
    ...
    const r = "radio" === e.getAttribute("role"),
      a =
        null === (o = null === (i = e.$fastController) || void 0 === i ? void 0 : i.definition.shadowOptions) ||
        void 0 === o
          ? void 0
          : o.delegatesFocus,
      l = Array.from(
        null !== (n = null === (s = e.shadowRoot) || void 0 === s ? void 0 : s.querySelectorAll("*")) && void 0 !== n
          ? n
          : [],
      ).some((t) => Lo(t));
    return e.hasAttribute("disabled") || e.hasAttribute("hidden") || !(Lo(e) || r || a || l)
      ? e.childElementCount
        ? t.concat(Array.from(e.children).reduce(Hs.reduceFocusableItems, []))
        : t
      : (t.push(e), t);
  }
...
Kt([f], Hs.prototype, "direction", void 0),
  Kt([st], Hs.prototype, "orientation", void 0),
  Kt([f], Hs.prototype, "slottedItems", void 0),
  Kt([f], Hs.prototype, "slottedLabel", void 0),
  Kt([f], Hs.prototype, "childItems", void 0);
class Ms {}
Kt([st({ attribute: "aria-labelledby" })], Ms.prototype, "ariaLabelledby", void 0),
  Kt([st({ attribute: "aria-label" })], Ms.prototype, "ariaLabel", void 0),
  Ae(Ms, Je),
  Ae(Hs, Ut, Ms);
const Bs = "top",
  Ns = "right",
...
class tn extends Ee {
  constructor() {
    super(...arguments),
      ...
      (this.startShowDelayTimer = () => {
        this.isAnchorHoveredFocused ||
          (this.delay > 1
            ? null === this.showDelayTimer &&
      ...
      (this.showTooltip = () => {
        this.tooltipVisible ||
          ...
          document.addEventListener("keydown", this.handleDocumentKeydown),
          d.queueUpdate(this.setRegionProps));
      }),
      (this.hideTooltip = () => {
        this.tooltipVisible &&
          (this.clearHideDelayTimer(),
      ...
      (this.setRegionProps = () => {
        this.tooltipVisible &&
          ...
          this.region.addEventListener("mouseover", this.handleRegionMouseOver, { passive: !0 }),
          this.region.addEventListener("mouseout", this.handleRegionMouseOut, { passive: !0 }));
      });
  }
  visibleChanged() {
  ...
  anchorElementChanged(t) {
    if (this.$fastController.isConnected) {
      if (
        ...
        this.anchorElement.addEventListener("mouseover", this.handleAnchorMouseOver, { passive: !0 }),
          this.anchorElement.addEventListener("mouseout", this.handleAnchorMouseOut, { passive: !0 }),
          this.anchorElement.addEventListener("focusin", this.handleAnchorFocusIn, { passive: !0 }),
        ...
        null !== this.anchorElement.parentElement &&
          this.anchorElement.parentElement.querySelectorAll(":hover").forEach((e) => {
...
Kt([st({ mode: "boolean" })], tn.prototype, "visible", void 0),
  Kt([st], tn.prototype, "anchor", void 0),
  Kt([st], tn.prototype, "delay", void 0),
  Kt([st], tn.prototype, "position", void 0),
  Kt([st({ attribute: "auto-update-mode" })], tn.prototype, "autoUpdateMode", void 0),
  Kt([st({ attribute: "horizontal-viewport-lock" })], tn.prototype, "horizontalViewportLock", void 0),
  Kt([st({ attribute: "vertical-viewport-lock" })], tn.prototype, "verticalViewportLock", void 0),
  Kt([f], tn.prototype, "anchorElement", void 0),
  Kt([f], tn.prototype, "viewportElement", void 0),
  Kt([f], tn.prototype, "verticalPositioningMode", void 0),
  Kt([f], tn.prototype, "horizontalPositioningMode", void 0),
  Kt([f], tn.prototype, "horizontalInset", void 0),
  Kt([f], tn.prototype, "verticalInset", void 0),
  Kt([f], tn.prototype, "horizontalScaling", void 0),
  Kt([f], tn.prototype, "verticalScaling", void 0),
  Kt([f], tn.prototype, "verticalDefaultPosition", void 0),
  Kt([f], tn.prototype, "horizontalDefaultPosition", void 0),
  Kt([f], tn.prototype, "tooltipVisible", void 0),
  Kt([f], tn.prototype, "currentDirection", void 0);
function en(t) {
...
class on extends Ee {
  constructor() {
    super(...arguments),
      (this.expanded = !1),
      (this.focusable = !1),
      (this.isNestedItem = () => en(this.parentElement)),
...
Kt([st({ mode: "boolean" })], on.prototype, "expanded", void 0),
  Kt([st({ mode: "boolean" })], on.prototype, "selected", void 0),
  Kt([st({ mode: "boolean" })], on.prototype, "disabled", void 0),
  Kt([f], on.prototype, "focusable", void 0),
  Kt([f], on.prototype, "childItems", void 0),
  Kt([f], on.prototype, "items", void 0),
  Kt([f], on.prototype, "nested", void 0),
  Kt([f], on.prototype, "renderCollapsedChildren", void 0),
  Ae(on, Ut);
class sn extends Ee {
  constructor() {
    super(...arguments),
      ...
      (this.handleFocus = (t) => {
        if (!(this.slottedTreeItems.length < 1))
          return t.target === this
            ? (null === this.currentFocused && (this.currentFocused = this.getValidFocusableItem()),
              void (null !== this.currentFocused && on.focusItem(this.currentFocused)))
            : void (this.contains(t.target) && (this.setAttribute("tabindex", "-1"), (this.currentFocused = t.target)));
      }),
      (this.handleBlur = (t) => {
        ...
        switch (t.key) {
          ...
          case "ArrowLeft":
            if (t.target && this.isFocusableElement(t.target)) {
              const e = t.target;
              e instanceof on && e.childItemLength() > 0 && e.expanded
                ? (e.expanded = !1)
                : e instanceof on && e.parentElement instanceof on && on.focusItem(e.parentElement);
            }
            return !1;
          case "ArrowRight":
            if (t.target && this.isFocusableElement(t.target)) {
              ...
              e instanceof on && e.childItemLength() > 0 && !e.expanded
                ? (e.expanded = !0)
                : e instanceof on && e.childItemLength() > 0 && this.focusNextNode(1, t.target);
            }
            return;
          case "ArrowDown":
      ...
      (this.handleSelectedChange = (t) => {
        ...
        const e = t.target;
        e.selected
          ? (this.currentSelected && this.currentSelected !== e && (this.currentSelected.selected = !1),
            (this.currentSelected = e))
          : e.selected || this.currentSelected !== e || (this.currentSelected = null);
      }),
      (this.setItems = () => {
        const t = this.treeView.querySelector("[aria-selected='true']");
        (this.currentSelected = t),
          (null !== this.currentFocused && this.contains(this.currentFocused)) ||
      ...
      (this.isFocusableElement = (t) => en(t)),
...
Kt([st({ attribute: "render-collapsed-nodes" })], sn.prototype, "renderCollapsedNodes", void 0),
  Kt([f], sn.prototype, "currentSelected", void 0),
  Kt([f], sn.prototype, "slottedTreeItems", void 0);
...
class vn {
  ...
  toStringWebRGBA() {
    return `rgba(${Math.round(un(this.r, 0, 255))},${Math.round(un(this.g, 0, 255))},${Math.round(
      un(this.b, 0, 255),
    )},${hn(this.a, 0, 1)})`;
  }
  roundToPrecision(t) {
...
function wn(t) {
  ...
  0 !== o &&
    (s =
      e === t.r ? (((t.g - t.b) / o) % 6) * 60 : e === t.g ? 60 * ((t.b - t.r) / o + 2) : 60 * ((t.r - t.g) / o + 4)),
    s < 0 && (s += 360);
  const n = (e + i) / 2;
  let r = 0;
...
function kn(t) {
  return (function (t) {
    ...
    const i = e(t.x / bn.whitePoint.x),
      o = e(t.y / bn.whitePoint.y),
      s = e(t.z / bn.whitePoint.z);
...
function Cn(t, e = 1) {
  return (function (t, e = 1) {
    ...
    (function (t) {
      ...
      let c = 0;
      return (
        (c = r > mn.epsilon ? r : (116 * o - 16) / mn.kappa),
        (a = bn.whitePoint.x * a),
        (l = bn.whitePoint.y * l),
        (c = bn.whitePoint.z * c),
        new bn(a, l, c)
...
function Dn(t, e, i) {
  return isNaN(t) || t <= 0
    ...
    : t >= 1
    ? i
    : new vn(pn(t, e.r, i.r), pn(t, e.g, i.g), pn(t, e.b, i.b), pn(t, e.a, i.a));
}
(bn.whitePoint = new bn(0.95047, 1, 1.08883)),
  (function (t) {
    (t[(t.Burn = 0)] = "Burn"),
      (t[(t.Color = 1)] = "Color"),
      (t[(t.Darken = 2)] = "Darken"),
...
function Sn(t) {
  ...
  return isNaN(o)
    ? null
    : new vn(dn((16711680 & o) >>> 16, 0, 255), dn((65280 & o) >>> 8, 0, 255), dn(255 & o, 0, 255), 1);
}
function On(t, e) {
...
class Vn extends vn {
  constructor(t, e, i) {
    super(t, e, i, 1),
      ...
      (this.contrast = On.bind(null, this)),
      (this.createCSS = this.toColorString),
      (this.relativeLuminance = yn(this));
  }
  static fromObject(t) {
    return new Vn(t.r, t.g, t.b);
  }
}
const Rn = (-0.1 + Math.sqrt(0.21)) / 2;
function An(t) {
...
const Pn = { stepContrast: 1.03, stepContrastRamp: 0.03, preserveSource: !1 };
const zn = Object.freeze({
  ...
  from: function (t, e) {
    return (function (t) {
      ...
      ? Hn.from(t, e)
      : Hn.from(En.create(t.r, t.g, t.b), e);
  },
});
class Hn {
  constructor(t, e) {
  ...
  closestIndexOf(t) {
    ...
    const i = this.swatches.reduce((e, i) =>
      Math.abs(i.relativeLuminance - t.relativeLuminance) < Math.abs(e.relativeLuminance - t.relativeLuminance) ? i : e,
    );
  ...
  static ramp(t) {
    const e = t / 100;
    return e > 0.5 ? (e - 0.5) / 0.5 : 2 * e;
  }
  static createHighResolutionPalette(t) {
    const e = [],
      i = kn(vn.fromObject(t).roundToPrecision(4)),
      o = Cn(new mn(0, i.a, i.b))
        .clamp()
        .roundToPrecision(4),
      s = Cn(new mn(50, i.a, i.b))
        .clamp()
        .roundToPrecision(4),
      n = Cn(new mn(100, i.a, i.b))
        .clamp()
        .roundToPrecision(4),
      r = new vn(0, 0, 0),
      a = new vn(1, 1, 1),
    ...
    for (let t = 100 + l; t >= 0 - c; t -= 0.5) {
      let i;
      if (t < 0) {
        i = Dn(t / c + 1, r, o);
      } else if (t <= 50) i = Dn(Hn.ramp(t), o, s);
      else if (t <= 100) i = Dn(Hn.ramp(t), s, n);
      else {
        i = Dn((t - 100) / l, n, a);
      }
  ...
  static adjustEnd(t, e, i, o) {
    const s = -1 === o ? e.swatches : e.reversedSwatches,
      n = (t) => {
    ...
    if (gn(On(i[i.length - 1], i[i.length - 2]), 2) < r) {
      ...
      for (let o = i.length - t - 1; o < i.length; o++) {
        const t = n(i[o]),
          r = o === i.length - 1 ? e.lastIndex : t + a;
        (i[o] = s[r]), a++;
      }
    }
    1 === o && i.reverse();
  ...
  static createColorPaletteByContrast(t, e) {
    const i = Hn.createHighResolutionPalette(t),
      o = (t) => gn(e.stepContrast + e.stepContrast * (1 - t.relativeLuminance) * e.stepContrastRamp, 2),
      s = [];
...
const Mn = En.create(1, 1, 1),
  Bn = En.create(0, 0, 0),
  Nn = En.create(0.5, 0.5, 0.5),
  jn = Sn("#0078D4"),
  Un = En.create(jn.r, jn.g, jn.b);
function qn(t, e, i, o, s) {
  const n = (t) => (t.contrast(Mn) >= s ? Mn : Bn),
    r = n(t),
    a = n(e);
...
class _n {
  constructor(t, e, i, o) {
    (this.toColorString = () => this.cssGradient),
      (this.contrast = On.bind(null, this)),
      (this.createCSS = this.toColorString),
      (this.color = new vn(t, e, i)),
      (this.cssGradient = o),
      (this.relativeLuminance = yn(this.color)),
      (this.r = t),
      (this.g = e),
      (this.b = i);
  }
  ...
  function d(i) {
    if (c) {
      const o = t.closestIndexOf(e),
        s = t.get(o),
        n = i.relativeLuminance < e.relativeLuminance ? Gn : Wn,
        r = (function (t, e, i = null) {
          ...
          return (
            null !== s
              ? (o = $n(t, e, s))
              : ((s = new vn(0, 0, 0, 1)), (o = $n(t, e, s)), o <= 0 && ((s = new vn(1, 1, 1, 1)), (o = $n(t, e, s)))),
            (o = Math.round(1e3 * o) / 1e3),
            new vn(s.r, s.g, s.b, o)
          );
        })(Sn(i.toColorString()), Sn(s.toColorString()), n).roundToPrecision(2),
        a = (function (t, e) {
          if (e.a >= 1) return e;
          if (e.a <= 0) return new vn(t.r, t.g, t.b, 1);
          const i = e.a * e.r + (1 - e.a) * t.r,
            o = e.a * e.g + (1 - e.a) * t.g,
            s = e.a * e.b + (1 - e.a) * t.b;
...
function Yn(t, e, i, o, s, n, r) {
  ...
  return (
    null == r && (r = Ln(e)),
    { rest: t.get(a + r * i), hover: t.get(a + r * o), active: t.get(a + r * s), focus: t.get(a + r * n) }
  );
}
...
!(function (t) {
  (t[(t.LightMode = 0.98)] = "LightMode"), (t[(t.DarkMode = 0.15)] = "DarkMode");
})(Zn || (Zn = {}));
const { create: er } = vo;
function ir(t) {
  return vo.create({ name: t, cssCustomPropertyName: null });
}
const or = er("direction").withDefault(je.ltr),
  sr = er("disabled-opacity").withDefault(0.3),
  nr = er("base-height-multiplier").withDefault(8),
  rr = er("base-horizontal-spacing-multiplier").withDefault(3),
  ar = er("density").withDefault(0),
  lr = er("design-unit").withDefault(4),
  cr = er("control-corner-radius").withDefault(4),
  hr = er("layer-corner-radius").withDefault(8),
  dr = er("stroke-width").withDefault(1),
  ur = er("focus-stroke-width").withDefault(2),
  pr = er("body-font").withDefault('"Segoe UI Variable", "Segoe UI", sans-serif'),
  gr = er("font-weight").withDefault(400);
function fr(t) {
  return (e) => {
    const i = t.getValueFor(e),
      o = gr.getValueFor(e);
    if (i.endsWith("px")) {
...
const mr = er("type-ramp-base-font-size").withDefault("14px"),
  ...
  Ur = er("base-layer-luminance").withDefault(Zn.LightMode),
  qr = ir("accent-fill-rest-delta").withDefault(0),
  _r = ir("accent-fill-hover-delta").withDefault(-2),
  Gr = ir("accent-fill-active-delta").withDefault(-5),
  Wr = ir("accent-fill-focus-delta").withDefault(0),
  Kr = ir("accent-foreground-rest-delta").withDefault(0),
  Xr = ir("accent-foreground-hover-delta").withDefault(3),
  Yr = ir("accent-foreground-active-delta").withDefault(-8),
  Qr = ir("accent-foreground-focus-delta").withDefault(0),
  Zr = ir("neutral-fill-rest-delta").withDefault(-1),
  Jr = ir("neutral-fill-hover-delta").withDefault(1),
  ta = ir("neutral-fill-active-delta").withDefault(0),
  ea = ir("neutral-fill-focus-delta").withDefault(0),
  ia = ir("neutral-fill-input-rest-delta").withDefault(-1),
  oa = ir("neutral-fill-input-hover-delta").withDefault(1),
  sa = ir("neutral-fill-input-active-delta").withDefault(0),
  ...
  ha = ir("neutral-fill-layer-rest-delta").withDefault(-2),
  da = ir("neutral-fill-layer-hover-delta").withDefault(-3),
  ...
  wa = ir("neutral-fill-strong-rest-delta").withDefault(0),
  ka = ir("neutral-fill-strong-hover-delta").withDefault(8),
  Ca = ir("neutral-fill-strong-active-delta").withDefault(-5),
  Ia = ir("neutral-fill-strong-focus-delta").withDefault(0),
  Fa = ir("neutral-stroke-rest-delta").withDefault(8),
  Da = ir("neutral-stroke-hover-delta").withDefault(12),
  Ta = ir("neutral-stroke-active-delta").withDefault(6),
  Sa = ir("neutral-stroke-focus-delta").withDefault(8),
  Oa = ir("neutral-stroke-control-rest-delta").withDefault(3),
  ...
  Ba = ir("neutral-stroke-strong-focus-delta").withDefault(0),
  Na = er("neutral-base-color").withDefault(Nn),
  ...
  _a = ir("neutral-layer-card-container-recipe").withDefault({
    evaluate: (t) => tr(ja.getValueFor(t), Ur.getValueFor(t), ha.getValueFor(t)),
  }),
  ...
  Qa = ir("neutral-layer-2-recipe").withDefault({
    evaluate: (t) => tr(ja.getValueFor(t), Ur.getValueFor(t), ha.getValueFor(t)),
  }),
...
const nl = ir("accent-fill-recipe").withDefault({
    evaluate: (t, e) =>
      (function (t, e, i, o, s, n, r, a, l, c, h, d, u, p) {
  ...
  hl = ir("foreground-on-accent-recipe").withDefault({
    evaluate: (t) => qn(rl.getValueFor(t), al.getValueFor(t), ll.getValueFor(t), cl.getValueFor(t), sl.normal),
  }),
  ...
  fl = ir("accent-foreground-recipe").withDefault({
    evaluate: (t, e) =>
      Xn(
        qa.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  xl = ir("accent-stroke-control-recipe").withDefault({
    evaluate: (t, e) => Kn(ja.getValueFor(t), e || ol.getValueFor(t), -3, -3, -3, -3, 10, 1, void 0, !0),
  }),
  ...
  Il = ir("neutral-fill-recipe").withDefault({
    evaluate: (t, e) =>
      Qn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  Ol = ir("neutral-fill-input-recipe").withDefault({
    evaluate: (t, e) =>
      Qn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  Ll = ir("neutral-fill-input-alt-recipe").withDefault({
    evaluate: (t, e) =>
      Qn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
        ...
        1,
        ra.getValueFor(t),
        ra.getValueFor(t) - aa.getValueFor(t),
        ra.getValueFor(t) - la.getValueFor(t),
        ca.getValueFor(t),
        1,
      ),
  }),
  ...
  Bl = ir("neutral-fill-layer-recipe").withDefault({
    evaluate: (t, e) =>
      Yn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  ql = ir("neutral-fill-layer-alt-recipe").withDefault({
    evaluate: (t, e) =>
      Yn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  Gl = ir("neutral-fill-secondary-recipe").withDefault({
    evaluate: (t, e) =>
      Yn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  Ql = ir("neutral-fill-stealth-recipe").withDefault({
    evaluate: (t, e) =>
      Yn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  ic = ir("neutral-fill-strong-recipe").withDefault({
    evaluate: (t, e) =>
      Xn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  ac = ir("neutral-foreground-recipe").withDefault({
    evaluate: (t, e) => Xn(ja.getValueFor(t), e || ol.getValueFor(t), 16, 0, -19, -30, 0),
  }),
  ...
  gc = ir("neutral-stroke-recipe").withDefault({
    evaluate: (t, e) =>
      Yn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  yc = ir("neutral-stroke-control-recipe").withDefault({
    evaluate: (t, e) =>
      Kn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  Ec = ir("neutral-stroke-layer-recipe").withDefault({
    evaluate: (t, e) =>
      Yn(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  Lc = ir("neutral-stroke-strong-recipe").withDefault({
    evaluate: (t, e) =>
      Xn(ja.getValueFor(t), e || ol.getValueFor(t), 5.5, 0, Ha.getValueFor(t), Ma.getValueFor(t), Ba.getValueFor(t)),
  }),
  ...
  Bc = ir("focus-stroke-outer-recipe").withDefault({
    evaluate: (t) => (ja.getValueFor(t), An(ol.getValueFor(t)) ? Mn : Bn),
  }),
  ...
  qc = ir("foreground-on-accent-large-recipe").withDefault({
    evaluate: (t) => qn(rl.getValueFor(t), al.getValueFor(t), ll.getValueFor(t), cl.getValueFor(t), sl.large),
  }),
  _c = er("foreground-on-accent-rest-large").withDefault((t) => qc.getValueFor(t).evaluate(t).rest),
  Gc = er("foreground-on-accent-hover-large").withDefault(
    (t) => qc.getValueFor(t).evaluate(t, al.getValueFor(t)).hover,
  ),
  Wc = er("foreground-on-accent-active-large").withDefault(
    (t) => qc.getValueFor(t).evaluate(t, ll.getValueFor(t)).active,
  ),
  Kc = er("foreground-on-accent-focus-large").withDefault(
    (t) => qc.getValueFor(t).evaluate(t, cl.getValueFor(t)).focus,
  ),
...
const Jc = ir("neutral-fill-inverse-recipe").withDefault({
    evaluate: (t, e) =>
      (function (t, e, i, o, s, n) {
        ...
        let c, h;
        return (
          (1 === r ? i < o : r * i > r * o) ? ((c = a), (h = l)) : ((c = l), (h = a)),
          { rest: t.get(c), hover: t.get(h), active: t.get(c + r * s), focus: t.get(c + r * n) }
        );
      })(
        ja.getValueFor(t),
        e || ol.getValueFor(t),
  ...
  oh = er("neutral-fill-inverse-focus").withDefault((t) => Jc.getValueFor(t).evaluate(t).focus),
  sh = cr,
  nh = hr,
  rh = dr,
  ah = ur,
...
`,
  ...
  id = (t, e) =>
    ...
    ${ln(
      "flex",
    )} :host{box-sizing:border-box;${Bh};flex-direction:column;background:${Nl};color:${lc};border:calc(${dr} * 1px) solid ${Vc};border-radius:calc(${hr} * 1px)}.region{display:none;padding:calc(${lr} * 2 * 1px);background:${_l}}.heading{display:grid;position:relative;grid-template-columns:auto 1fr auto auto;align-items:center}.button{appearance:none;border:none;background:none;grid-column:2;grid-row:1;outline:none;margin:calc(${lr} * 3 * 1px) 0;padding:0 calc(${lr} * 2 * 1px);text-align:left;color:inherit;cursor:pointer;font:inherit}.button::before{content:'';position:absolute;top:calc(${dr} * -1px);left:calc(${dr} * -1px);right:calc(${dr} * -1px);bottom:calc(${dr} * -1px);cursor:pointer}.button:${cn}::before{${Yh}
      border-radius:calc(${hr} * 1px)}:host(.expanded) .button:${cn}::before{border-bottom-left-radius:0;border-bottom-right-radius:0}:host(.expanded) .region{display:block;border-top:calc(${dr} * 1px) solid ${Vc};border-bottom-left-radius:calc((${hr} - ${dr}) * 1px);border-bottom-right-radius:calc((${hr} - ${dr}) * 1px)}.icon{display:flex;align-items:center;justify-content:center;grid-column:4;pointer-events:none;background:${Jh};border-radius:calc(${cr} * 1px);fill:currentcolor;width:calc(${Zh} * 1px);height:calc(${Zh} * 1px);margin:calc(${lr} * 2 * 1px)}.heading:hover .icon{background:${td}}.heading:active .icon{background:${ed}}slot[name='collapsed-icon']{display:flex}:host(.expanded) slot[name='collapsed-icon']{display:none}slot[name='expanded-icon']{display:none}:host(.expanded) slot[name='expanded-icon']{display:flex}.start{display:flex;align-items:center;padding-inline-start:calc(${lr} * 2 * 1px);justify-content:center;grid-column:1}.end{display:flex;align-items:center;justify-content:center;grid-column:3}.icon,.start,.end{position:relative}`.withBehaviors(
      rn(vt`
        .button:${cn}::before{outline-color:${Ke.Highlight}}.icon{fill:${Ke.ButtonText}}`),
    ),
  od = Le.compose({
    baseName: "accordion-item",
    template: (t, e) =>
      _`<template class="${(t) =>
        t.expanded ? "expanded" : ""}"><div class="heading" part="heading" role="heading" aria-level="${(t) =>
        t.headinglevel}"><button class="button" part="button" ${St("expandbutton")} aria-expanded="${(t) =>
        t.expanded}" aria-controls="${(t) => t.id}-panel" id="${(t) => t.id}" @click="${(t, e) =>
        t.clickHandler(
          e.event,
        )}"><span class="heading-content" part="heading-content"><slot name="heading"></slot></span></button>${_t(
        0,
        e,
      )} ${qt(0, e)}<span class="icon" part="icon" aria-hidden="true"><slot name="expanded-icon" part="expanded-icon">${
        e.expandedIcon || ""
      }</slot><slot name="collapsed-icon" part="collapsed-icon">${
        e.collapsedIcon || ""
      }</slot><span></div><div class="region" part="region" id="${(t) => t.id}-panel" role="region" aria-labelledby="${(
        t,
  ...
  nd = Qe.compose({
    baseName: "accordion",
    template: (t, e) =>
      _`<template><slot ${Bt({ property: "accordionItems", filter: zt() })}></slot><slot name="item" part="item" ${Bt(
        "accordionItems",
      )}></slot></template>`,
    styles: Xh,
  }),
...
class ld {
  ...
  attach(t) {
    const e = this.cache.get(t) || new cd(this.ltr, this.rtl, t),
      i = or.getValueFor(t);
...
class cd {
  ...
  attach(t) {
    this.attached !== this[t] &&
      (null !== this.attached && this.source.$fastController.removeStyles(this.attached),
      (this.attached = this[t]),
      null !== this.attached && this.source.$fastController.addStyles(this.attached));
  }
}
const hd = "0 0 2px rgba(0, 0, 0, 0.14)",
  ...
  Sd = (t, e, i, o = "[disabled]") =>
    vt`
    .control{background:padding-box linear-gradient(${Fl},${Fl}),border-box ${xc}}:host(${i}:hover) .control{background:padding-box linear-gradient(${Dl},${Dl}),border-box ${$c}}:host(${i}:active) .control{background:padding-box linear-gradient(${Tl},${Tl}),border-box ${wc}}:host(${o}) .control{background:padding-box linear-gradient(${Fl},${Fl}),border-box ${fc}}`.withBehaviors(
      rn(vt`
  ...
  Vd = (t, e, i, o = "[disabled]") =>
    vt`
    :host{color:${ml}}.control{background:${Zl}}:host(${i}:hover) .control{background:${Jl};color:${vl}}:host(${i}:active) .control{background:${tc};color:${bl}}:host(${o}) .control{background:${Zl}}`.withBehaviors(
      rn(vt`
  ...
  Rd = (t, e, i, o = "[disabled]") =>
    vt`
    .control{background:transparent !important;border-color:${fc}}:host(${i}:hover) .control{border-color:${mc}}:host(${i}:active) .control{border-color:${vc}}:host(${o}) .control{background:transparent !important;border-color:${fc}}`.withBehaviors(
      rn(vt`
  ...
  Ad = (t, e, i, o = "[disabled]") =>
    vt`
    .control{background:${Zl}}:host(${i}:hover) .control{background:${Jl}}:host(${i}:active) .control{background:${tc}}:host(${o}) .control{background:${Zl}}`.withBehaviors(
      rn(vt`
...
const _d = (t, e) =>
  Td().withBehaviors(
    qd("neutral", Sd(0, 0, "[href]")),
    qd("accent", Od(0, 0, "[href]")),
    qd("hypertext", Ed(0, 0, "[href]")),
    qd("lightweight", Vd(0, 0, "[href]")),
    qd("outline", Rd(0, 0, "[href]")),
    qd("stealth", Ad(0, 0, "[href]")),
  );
class Gd extends ti {
  ...
  defaultSlottedContentChanged() {
    ...
    1 === i.length && i[0] instanceof SVGElement
      ? null === (t = this.control) || void 0 === t || t.classList.add("icon-only")
      : null === (e = this.control) || void 0 === e || e.classList.remove("icon-only");
  }
}
...
const Wd = _d,
  ...
  Yd = oi.compose({
    ...
    template: (t, e) =>
      _`<template class="${(t) => (t.initialLayoutComplete ? "loaded" : "")}">${Ot(
  ...
  Zd = (t, e) => vt`
    ${ln(
      "inline-block",
    )} :host{box-sizing:border-box;${Nh}}.control{border-radius:calc(${cr} * 1px);padding:calc(((${lr} * 0.5) - ${dr}) * 1px) calc((${lr} - ${dr}) * 1px);border:calc(${dr} * 1px) solid transparent}:host(.lightweight) .control{background:transparent;color:${lc};font-weight:600}:host(.accent) .control{background:${rl};color:${dl}}:host(.neutral) .control{background:${Wl};color:${lc}}:host([circular]) .control{border-radius:100px;min-width:calc(${xr} - calc(${lr} * 1px));display:flex;align-items:center;justify-content:center}`;
class Jd extends si {
  constructor() {
...
const tu = Jd.compose({
    ...
    baseClass: si,
    template: (t, e) =>
      _`<template class="${(t) => (t.circular ? "circular" : "")}"><div class="control" part="control" style="${(t) =>
        t.generateBadgeStyle()}"><slot></slot></div></template>`,
    styles: Zd,
  }),
  eu = Zd,
  iu = (t, e) => vt`
  ${ln("inline-block")} :host{box-sizing:border-box;${Bh}}.list{display:flex}`,
  ou = ri.compose({
    baseName: "breadcrumb",
    template: (t, e) =>
      _`<template role="navigation"><div role="list" class="list" part="list"><slot ${Bt({
  ...
  ru = ni.compose({
    ...
    template: (t, e) =>
      _`<div role="listitem" class="listitem" part="listitem">${Ot(
        (t) => t.href && t.href.length > 0,
        _` ${Ze(0, e)} `,
      )} ${Ot((t) => !t.href, _` ${_t(0, e)}<slot></slot>${qt(0, e)} `)} ${Ot(
        (t) => t.separator,
        _`<span class="separator" part="separator" aria-hidden="true"><slot name="separator">${
          e.separator || ""
        }</slot></span>`,
      )}</div>`,
    styles: nu,
  ...
  lu = (t, e) =>
    vt`
    :host(${":not([disabled])"}) .control{cursor:pointer}:host(${"[disabled]"}) .control{cursor:${"not-allowed"}}@media (forced-colors:none){:host(${"[disabled]"}) .control{opacity:${sr}}}${Td(
      0,
      0,
      0,
      "[disabled]",
  ...
  `.withBehaviors(
      qd("neutral", Sd(0, 0, ":not([disabled])", "[disabled]")),
      qd("accent", Od(0, 0, ":not([disabled])", "[disabled]")),
      qd("lightweight", Vd(0, 0, ":not([disabled])", "[disabled]")),
      qd("outline", Rd(0, 0, ":not([disabled])", "[disabled]")),
      qd("stealth", Ad(0, 0, ":not([disabled])", "[disabled]")),
    );
class cu extends pi {
  appearanceChanged(t, e) {
    t !== e && (this.classList.add(e), this.classList.remove(t));
  ...
  defaultSlottedContentChanged() {
    ...
    1 === t.length && t[0] instanceof SVGElement
...
const hu = cu.compose({
    ...
    baseClass: pi,
    template: (t, e) =>
      _`<button class="control" part="control" ?autofocus="${(t) => t.autofocus}" ?disabled="${(t) =>
        t.disabled}" form="${(t) => t.formId}" formaction="${(t) => t.formaction}" formenctype="${(t) =>
        t.formenctype}" formmethod="${(t) => t.formmethod}" formnovalidate="${(t) => t.formnovalidate}" formtarget="${(
        t,
      ) => t.formtarget}" name="${(t) => t.name}" type="${(t) => t.type}" value="${(t) => t.value}" aria-atomic="${(
        t,
      ) => t.ariaAtomic}" aria-busy="${(t) => t.ariaBusy}" aria-controls="${(t) => t.ariaControls}" aria-current="${(
        t,
      ) => t.ariaCurrent}" aria-describedby="${(t) => t.ariaDescribedby}" aria-details="${(t) =>
        t.ariaDetails}" aria-disabled="${(t) => t.ariaDisabled}" aria-errormessage="${(t) =>
        t.ariaErrormessage}" aria-expanded="${(t) => t.ariaExpanded}" aria-flowto="${(t) =>
        t.ariaFlowto}" aria-haspopup="${(t) => t.ariaHaspopup}" aria-hidden="${(t) => t.ariaHidden}" aria-invalid="${(
        t,
      ) => t.ariaInvalid}" aria-keyshortcuts="${(t) => t.ariaKeyshortcuts}" aria-label="${(t) =>
        t.ariaLabel}" aria-labelledby="${(t) => t.ariaLabelledby}" aria-live="${(t) => t.ariaLive}" aria-owns="${(t) =>
        t.ariaOwns}" aria-pressed="${(t) => t.ariaPressed}" aria-relevant="${(t) =>
        t.ariaRelevant}" aria-roledescription="${(t) => t.ariaRoledescription}" ${St("control")}>${_t(
        0,
        e,
      )}<span class="content" part="content"><slot ${Bt("defaultSlottedContent")}></slot></span>${qt(0, e)}</button>`,
    styles: lu,
    shadowOptions: { delegatesFocus: !0 },
  }),
  du = lu,
...
const fu = gu.compose({
    ...
    template: (t, e) => {
      var i;
      const o = new Date(),
        s = `${o.getMonth() + 1}-${o.getDate()}-${o.getFullYear()}`;
      return _`<template>${Wt} ${
        e.title instanceof Function ? e.title(t, e) : null !== (i = e.title) && void 0 !== i ? i : ""
      }<slot></slot>${Ot((t) => !1 === t.readonly, Ri(t, s))} ${Ot(
        (t) => !0 === t.readonly,
        ((t) =>
          _`<div class="days" part="days"><div class="week-days" part="week-days">${Pt(
            (t) => t.getWeekdayText(),
            _`<div class="week-day" part="week-day" abbr="${(t) => t.abbr}">${(t) => t.text}</div>`,
          )}</div>${Pt(
            (t) => t.getDays(),
            _`<div class="week">${Pt(
              (t) => t,
              _`<div class="${(e, i) => i.parentContext.parent.getDayClassNames(e, t)}" part="day" aria-label="${(
                t,
                e,
              ) =>
                e.parentContext.parent.dateFormatter.getDate(`${t.month}-${t.day}-${t.year}`, {
                  month: "long",
                  day: "numeric",
                })}"><div class="date" part="${(e) => (t === `${e.month}-${e.day}-${e.year}` ? "today" : "date")}">${(
                t,
                e,
              ) => e.parentContext.parent.dateFormatter.getDay(t.day)}</div><slot name="${(t) => t.month}-${(t) =>
                t.day}-${(t) => t.year}"></slot></div>`,
            )}</div>`,
          )}</div>`)(s),
      )} ${Gt}</template>`;
    },
...
${ln("inline-block")} :host{--calendar-cell-size:calc((${nr} + 2 + ${ar}) * ${lr} * 1px);--calendar-gap:2px;${Bh}
  ...
  mu = (t, e) =>
    ...
    ${ln(
      "block",
    )} :host{display:block;contain:content;height:var(--card-height,100%);width:var(--card-width,100%);box-sizing:border-box;background:${ol};color:${lc};border:calc(${dr} * 1px) solid ${Vc};border-radius:calc(${hr} * 1px);box-shadow:${bd}}:host{content-visibility:auto}`.withBehaviors(
      rn(vt`
...
ad([st({ attribute: "card-fill-color", mode: "fromView" })], vu.prototype, "cardFillColor", void 0),
  ad([st({ attribute: "neutral-palette-source", mode: "fromView" })], vu.prototype, "neutralPaletteSource", void 0);
const bu = vu.compose({ baseName: "card", baseClass: Ai, template: (t, e) => _`<slot></slot>`, styles: mu }),
  yu = mu,
  xu = (t, e) =>
    vt`
    ${ln(
      "inline-flex",
    )} :host{align-items:center;outline:none;${""} user-select:none}.control{position:relative;width:calc((${Zh} / 2 + ${lr}) * 1px);height:calc((${Zh} / 2 + ${lr}) * 1px);box-sizing:border-box;border-radius:calc(${cr} * 1px);border:calc(${dr} * 1px) solid ${Pc};background:${Pl};cursor:pointer}.label__hidden{display:none;visibility:hidden}.label{${Bh}
  ...
  $u = zi.compose({
    baseName: "checkbox",
    template: (t, e) =>
      _`<template role="checkbox" aria-checked="${(t) => t.checked}" aria-required="${(t) =>
        t.required}" aria-disabled="${(t) => t.disabled}" aria-readonly="${(t) => t.readOnly}" tabindex="${(t) =>
        t.disabled ? null : 0}" @keypress="${(t, e) => t.keypressHandler(e.event)}" @click="${(t, e) =>
        t.clickHandler(e.event)}" class="${(t) => (t.readOnly ? "readonly" : "")} ${(t) =>
        t.checked ? "checked" : ""} ${(t) =>
        t.indeterminate ? "indeterminate" : ""}"><div part="control" class="control"><slot name="checked-indicator">${
        e.checkedIndicator || ""
      }</slot><slot name="indeterminate-indicator">${
        e.indeterminateIndicator || ""
      }</slot></div><label part="label" class="${(t) =>
        t.defaultSlottedNodes && t.defaultSlottedNodes.length ? "label" : "label label__hidden"}"><slot ${Bt(
        "defaultSlottedNodes",
      )}></slot></label></template>`,
    styles: xu,
    checkedIndicator:
  ...
  Cu = (t, e) =>
    ku().withBehaviors(
      qd("outline", Sd(0, 0, ":not([disabled]):not([open])", "[disabled]")),
      qd(
        "filled",
        jd(0, 0, ".control", ":not([disabled]):not([open])").withBehaviors(
          rn(Ud(0, 0, ".control", ":not([disabled]):not([open])")),
        ),
      ),
      qd("stealth", Ad(0, 0, ":not([disabled]):not([open])", "[disabled]")),
      rn(vt`
    :host([open]) .listbox{background:${Ke.ButtonFace};border-color:${Ke.CanvasText}}`),
    ),
  Iu = (t, e) =>
    vt`
    ${ku()}
    ...
    :host(:empty) .listbox{display:none}:host([disabled]) *,:host([disabled]){cursor:${"not-allowed"};user-select:none}:host(:active) .selected-value{user-select:none}.selected-value{-webkit-appearance:none;background:transparent;border:none;color:inherit;${Bh}
      height:calc(100% - ${dr} * 1px));margin:auto 0;width:100%;outline:none}`.withBehaviors(
      qd("outline", Nd(0, 0, ".control", ":not([disabled]):not([open])")),
      qd("filled", jd(0, 0, ".control", ":not([disabled]):not([open])")),
      rn(Ud(0, 0, ".control", ":not([disabled]):not([open])")),
    );
class Fu extends Qi {
  appearanceChanged(t, e) {
  ...
  connectedCallback() {
    super.connectedCallback(),
      ...
      this.listbox && ol.setValueFor(this.listbox, Ka);
  }
}
...
const Du = Fu.compose({
    ...
    shadowOptions: { delegatesFocus: !0 },
    template: (t, e) =>
      _`<template aria-disabled="${(t) => t.ariaDisabled}" autocomplete="${(t) => t.autocomplete}" class="${(t) =>
        t.open ? "open" : ""} ${(t) => (t.disabled ? "disabled" : "")} ${(t) => t.position}" ?open="${(t) =>
        t.open}" tabindex="${(t) => (t.disabled ? null : "0")}" @click="${(t, e) =>
        t.clickHandler(e.event)}" @focusout="${(t, e) => t.focusoutHandler(e.event)}" @keydown="${(t, e) =>
        t.keydownHandler(e.event)}"><div class="control" part="control">${_t(
        0,
        e,
      )}<slot name="control"><input aria-activedescendant="${(t) =>
        t.open ? t.ariaActiveDescendant : null}" aria-autocomplete="${(t) => t.ariaAutoComplete}" aria-controls="${(
        t,
      ) => t.ariaControls}" aria-disabled="${(t) => t.ariaDisabled}" aria-expanded="${(t) =>
        t.ariaExpanded}" aria-haspopup="listbox" class="selected-value" part="selected-value" placeholder="${(t) =>
        t.placeholder}" role="combobox" type="text" ?disabled="${(t) => t.disabled}" :value="${(t) =>
        t.value}" @input="${(t, e) => t.inputHandler(e.event)}" @keyup="${(t, e) => t.keyupHandler(e.event)}" ${St(
        "control",
      )} /><div class="indicator" part="indicator" aria-hidden="true"><slot name="indicator">${
        e.indicator || ""
      }</slot></div></slot>${qt(0, e)}</div><div class="listbox" id="${(t) =>
        t.listboxId}" part="listbox" role="listbox" ?disabled="${(t) => t.disabled}" ?hidden="${(t) => !t.open}" ${St(
        "listbox",
      )}><slot ${Bt({
  ...
  Ou = (t, e) =>
    vt`
    :host{display:grid;padding:1px 0;box-sizing:border-box;width:100%;border-bottom:calc(${dr} * 1px) solid ${Ic}}:host(.header){}:host(.sticky-header){background:${ol};position:sticky;top:0}`.withBehaviors(
      rn(vt`
        :host{}`),
    ),
  Eu = (t, e) =>
    ...
    :host{padding:calc((${lr} + ${ur} - ${dr}) * 1px) calc(((${lr} * 3) + ${ur} - ${dr}) * 1px);color:${lc};box-sizing:border-box;${Bh}
      border:transparent calc(${dr} * 1px) solid;overflow:hidden;white-space:nowrap;border-radius:calc(${cr} * 1px)}:host(.column-header){font-weight:600}:host(:${cn}){${Yh}}`.withBehaviors(
      rn(vt`
  ...
  Vu = Oi.compose({
    ...
    template: (t, e) =>
      _`<template tabindex="-1" role="${(t) =>
        t.cellType && "default" !== t.cellType ? t.cellType : "gridcell"}" class=" ${(t) =>
        "columnheader" === t.cellType
          ? "column-header"
          : "rowheader" === t.cellType
          ? "row-header"
          : ""} "><slot></slot></template>`,
    styles: Eu,
  }),
  ...
  Au = Fi.compose({
    ...
    template: (t, e) =>
      _`<template role="row" class="${(t) =>
        "default" !== t.rowType ? t.rowType : ""}" :defaultCellItemTemplate="${(function (t) {
        const e = t.tagFor(Oi);
        return _`<${e} cell-type="${(t) => (t.isRowHeader ? "rowheader" : void 0)}" grid-column="${(t, e) =>
          e.index + 1}" :rowData="${(t, e) => e.parent.rowData}" :columnDefinition="${(t) => t}"></${e}>`;
      })(t)}" :defaultHeaderCellItemTemplate="${(function (t) {
        const e = t.tagFor(Oi);
        return _`<${e} cell-type="columnheader" grid-column="${(t, e) => e.index + 1}" :columnDefinition="${(t) =>
          t}"></${e}>`;
      })(t)}" ${jt({
  ...
  Pu = Di.compose({
    ...
    template: (t, e) => {
      const i = (function (t) {
          const e = t.tagFor(Fi);
          return _`<${e} :rowData="${(t) => t}" :cellItemTemplate="${(t, e) =>
            e.parent.cellItemTemplate}" :headerCellItemTemplate="${(t, e) => e.parent.headerCellItemTemplate}"></${e}>`;
        })(t),
        o = t.tagFor(Fi);
  ...
  zu = Su,
  Hu = {
    toView: (t) => (null == t ? null : null == t ? void 0 : t.toColorString()),
    fromView(t) {
      if (null == t) return null;
      const e = Sn(t);
  ...
  Mu = vt`
  :host{background-color:${ol};color:${lc}}`.withBehaviors(
    rn(vt`
...
class Nu extends Ee {
  ...
  noPaintChanged() {
    this.noPaint || (void 0 === this.fillColor && !this.baseLayerLuminance)
      ? this.$fastController.removeStyles(Mu)
      : this.$fastController.addStyles(Mu);
  }
}
ad([st({ attribute: "no-paint", mode: "boolean" })], Nu.prototype, "noPaint", void 0),
  ad([st({ attribute: "fill-color", converter: Hu, mode: "fromView" }), Bu(ol)], Nu.prototype, "fillColor", void 0),
  ad(
    [st({ attribute: "accent-base-color", converter: Hu, mode: "fromView" }), Bu(Ua)],
    Nu.prototype,
    "accentBaseColor",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-base-color", converter: Hu, mode: "fromView" }), Bu(Na)],
    Nu.prototype,
    "neutralBaseColor",
    void 0,
  ),
  ad([st({ converter: it }), Bu(ar)], Nu.prototype, "density", void 0),
  ad([st({ attribute: "design-unit", converter: it }), Bu(lr)], Nu.prototype, "designUnit", void 0),
  ad([st({ attribute: "direction" }), Bu(or)], Nu.prototype, "direction", void 0),
  ad(
    [st({ attribute: "base-height-multiplier", converter: it }), Bu(nr)],
    Nu.prototype,
    "baseHeightMultiplier",
    void 0,
  ),
  ad(
    [st({ attribute: "base-horizontal-spacing-multiplier", converter: it }), Bu(rr)],
    Nu.prototype,
    "baseHorizontalSpacingMultiplier",
    void 0,
  ),
  ad([st({ attribute: "control-corner-radius", converter: it }), Bu(cr)], Nu.prototype, "controlCornerRadius", void 0),
  ad([st({ attribute: "layer-corner-radius", converter: it }), Bu(hr)], Nu.prototype, "layerCornerRadius", void 0),
  ad([st({ attribute: "stroke-width", converter: it }), Bu(dr)], Nu.prototype, "strokeWidth", void 0),
  ad([st({ attribute: "focus-stroke-width", converter: it }), Bu(ur)], Nu.prototype, "focusStrokeWidth", void 0),
  ad([st({ attribute: "disabled-opacity", converter: it }), Bu(sr)], Nu.prototype, "disabledOpacity", void 0),
  ad([st({ attribute: "type-ramp-minus-2-font-size" }), Bu(wr)], Nu.prototype, "typeRampMinus2FontSize", void 0),
  ad([st({ attribute: "type-ramp-minus-2-line-height" }), Bu(kr)], Nu.prototype, "typeRampMinus2LineHeight", void 0),
  ad([st({ attribute: "type-ramp-minus-1-font-size" }), Bu(yr)], Nu.prototype, "typeRampMinus1FontSize", void 0),
  ad([st({ attribute: "type-ramp-minus-1-line-height" }), Bu(xr)], Nu.prototype, "typeRampMinus1LineHeight", void 0),
  ad([st({ attribute: "type-ramp-base-font-size" }), Bu(mr)], Nu.prototype, "typeRampBaseFontSize", void 0),
  ad([st({ attribute: "type-ramp-base-line-height" }), Bu(vr)], Nu.prototype, "typeRampBaseLineHeight", void 0),
  ad([st({ attribute: "type-ramp-plus-1-font-size" }), Bu(Ir)], Nu.prototype, "typeRampPlus1FontSize", void 0),
  ad([st({ attribute: "type-ramp-plus-1-line-height" }), Bu(Fr)], Nu.prototype, "typeRampPlus1LineHeight", void 0),
  ad([st({ attribute: "type-ramp-plus-2-font-size" }), Bu(Tr)], Nu.prototype, "typeRampPlus2FontSize", void 0),
  ad([st({ attribute: "type-ramp-plus-2-line-height" }), Bu(Sr)], Nu.prototype, "typeRampPlus2LineHeight", void 0),
  ad([st({ attribute: "type-ramp-plus-3-font-size" }), Bu(Er)], Nu.prototype, "typeRampPlus3FontSize", void 0),
  ad([st({ attribute: "type-ramp-plus-3-line-height" }), Bu(Vr)], Nu.prototype, "typeRampPlus3LineHeight", void 0),
  ad([st({ attribute: "type-ramp-plus-4-font-size" }), Bu(Ar)], Nu.prototype, "typeRampPlus4FontSize", void 0),
  ad([st({ attribute: "type-ramp-plus-4-line-height" }), Bu(Lr)], Nu.prototype, "typeRampPlus4LineHeight", void 0),
  ad([st({ attribute: "type-ramp-plus-5-font-size" }), Bu(zr)], Nu.prototype, "typeRampPlus5FontSize", void 0),
  ad([st({ attribute: "type-ramp-plus-5-line-height" }), Bu(Hr)], Nu.prototype, "typeRampPlus5LineHeight", void 0),
  ad([st({ attribute: "type-ramp-plus-6-font-size" }), Bu(Br)], Nu.prototype, "typeRampPlus6FontSize", void 0),
  ad([st({ attribute: "type-ramp-plus-6-line-height" }), Bu(Nr)], Nu.prototype, "typeRampPlus6LineHeight", void 0),
  ad([st({ attribute: "accent-fill-rest-delta", converter: it }), Bu(qr)], Nu.prototype, "accentFillRestDelta", void 0),
  ad(
    [st({ attribute: "accent-fill-hover-delta", converter: it }), Bu(_r)],
    Nu.prototype,
    "accentFillHoverDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "accent-fill-active-delta", converter: it }), Bu(Gr)],
    Nu.prototype,
    "accentFillActiveDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "accent-fill-focus-delta", converter: it }), Bu(Wr)],
    Nu.prototype,
    "accentFillFocusDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "accent-foreground-rest-delta", converter: it }), Bu(Kr)],
    Nu.prototype,
    "accentForegroundRestDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "accent-foreground-hover-delta", converter: it }), Bu(Xr)],
    Nu.prototype,
    "accentForegroundHoverDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "accent-foreground-active-delta", converter: it }), Bu(Yr)],
    Nu.prototype,
    "accentForegroundActiveDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "accent-foreground-focus-delta", converter: it }), Bu(Qr)],
    Nu.prototype,
    "accentForegroundFocusDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-rest-delta", converter: it }), Bu(Zr)],
    Nu.prototype,
    "neutralFillRestDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-hover-delta", converter: it }), Bu(Jr)],
    Nu.prototype,
    "neutralFillHoverDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-active-delta", converter: it }), Bu(ta)],
    Nu.prototype,
    "neutralFillActiveDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-focus-delta", converter: it }), Bu(ea)],
    Nu.prototype,
    "neutralFillFocusDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-input-rest-delta", converter: it }), Bu(ia)],
    Nu.prototype,
    "neutralFillInputRestDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-input-hover-delta", converter: it }), Bu(oa)],
    Nu.prototype,
    "neutralFillInputHoverDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-input-active-delta", converter: it }), Bu(sa)],
    Nu.prototype,
    "neutralFillInputActiveDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-input-focus-delta", converter: it }), Bu(na)],
    Nu.prototype,
    "neutralFillInputFocusDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-layer-rest-delta", converter: it }), Bu(ha)],
    Nu.prototype,
    "neutralFillLayerRestDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-stealth-rest-delta", converter: it }), Bu(ba)],
    Nu.prototype,
    "neutralFillStealthRestDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-stealth-hover-delta", converter: it }), Bu(ya)],
    Nu.prototype,
    "neutralFillStealthHoverDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-stealth-active-delta", converter: it }), Bu(xa)],
    Nu.prototype,
    "neutralFillStealthActiveDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-stealth-focus-delta", converter: it }), Bu($a)],
    Nu.prototype,
    "neutralFillStealthFocusDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-strong-hover-delta", converter: it }), Bu(ka)],
    Nu.prototype,
    "neutralFillStrongHoverDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-strong-active-delta", converter: it }), Bu(Ca)],
    Nu.prototype,
    "neutralFillStrongActiveDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-fill-strong-focus-delta", converter: it }), Bu(Ia)],
    Nu.prototype,
    "neutralFillStrongFocusDelta",
    void 0,
  ),
  ad([st({ attribute: "base-layer-luminance", converter: it }), Bu(Ur)], Nu.prototype, "baseLayerLuminance", void 0),
  ad(
    [st({ attribute: "neutral-stroke-divider-rest-delta", converter: it }), Bu(Aa)],
    Nu.prototype,
    "neutralStrokeDividerRestDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-stroke-rest-delta", converter: it }), Bu(Fa)],
    Nu.prototype,
    "neutralStrokeRestDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-stroke-hover-delta", converter: it }), Bu(Da)],
    Nu.prototype,
    "neutralStrokeHoverDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-stroke-active-delta", converter: it }), Bu(Ta)],
    Nu.prototype,
    "neutralStrokeActiveDelta",
    void 0,
  ),
  ad(
    [st({ attribute: "neutral-stroke-focus-delta", converter: it }), Bu(Sa)],
    Nu.prototype,
...
const ju = Nu.compose({
  ...
  qu = Po.compose({
    baseName: "dialog",
    template: (t, e) =>
      _`<div class="positioning-region" part="positioning-region">${Ot(
        (t) => t.modal,
        _`<div class="overlay" part="overlay" role="presentation" @click="${(t) => t.dismiss()}"></div>`,
      )}<div role="dialog" tabindex="-1" class="control" part="control" aria-modal="${(t) =>
        t.modal}" aria-describedby="${(t) => t.ariaDescribedby}" aria-labelledby="${(t) =>
        t.ariaLabelledby}" aria-label="${(t) => t.ariaLabel}" ${St("dialog")}><slot></slot></div></div>`,
    styles: Uu,
  }),
  _u = Uu,
  Gu = (t, e) => vt`
    ${ln(
      "block",
    )} :host{box-sizing:content-box;height:0;border:none;border-top:calc(${dr} * 1px) solid ${Ic}}:host([orientation="vertical"]){border:none;height:100%;margin:0 calc(${lr} * 1px);border-left:calc(${dr} * 1px) solid ${Ic}}`,
  Wu = Ho.compose({
    baseName: "divider",
  ...
  Xu = (t, e) =>
    ...
    ${ln(
      "inline-flex",
    )} :host{height:calc((${Zh} + ${lr}) * 1px);justify-content:center;align-items:center;fill:currentcolor;color:${oc};background:padding-box linear-gradient(${Fl},${Fl}),border-box ${xc};box-sizing:border-box;border:calc(${dr} * 1px) solid transparent;border-radius:calc(${cr} * 1px);padding:0}:host(.disabled){opacity:${sr};cursor:${"not-allowed"};pointer-events:none}.next,.previous{display:flex}:host(:not(.disabled):hover){cursor:pointer}:host(:not(.disabled):hover){color:${sc}}:host(:not(.disabled):active){color:${nc}}:host(:${cn}){${Yh}}:host::-moz-focus-inner{border:0}`.withBehaviors(
      rn(vt`
  ...
  Yu = No.compose({
    baseName: "flipper",
    template: (t, e) =>
      _`<template role="button" aria-disabled="${(t) => !!t.disabled || void 0}" tabindex="${(t) =>
        t.hiddenFromAT ? -1 : 0}" class="${(t) => t.direction} ${(t) => (t.disabled ? "disabled" : "")}" @keyup="${(
        t,
        e,
      ) => t.keyupHandler(e.event)}">${Ot(
        (t) => t.direction === Mo,
        _`<span part="next" class="next"><slot name="next">${e.next || ""}</slot></span>`,
      )} ${Ot(
        (t) => t.direction === Bo,
        _`<span part="previous" class="previous"><slot name="previous">${e.previous || ""}</slot></span>`,
      )}</template>`,
    styles: Xu,
...
const op = ip.compose({
    ...
    template: (t, e) => {
      var i, o;
      return _`<template class="horizontal-scroll" @keyup="${(t, e) => t.keyupHandler(e.event)}">${_t(
        0,
        e,
      )}<div class="scroll-area" part="scroll-area"><div class="scroll-view" part="scroll-view" @scroll="${(t) =>
        t.scrolled()}" ${St("scrollContainer")}><div class="content-container" part="content-container" ${St(
        "content",
      )}><slot ${Bt({ property: "scrollItems", filter: zt() })}></slot></div></div>${Ot(
        (t) => "mobile" !== t.view,
        _`<div class="scroll scroll-prev" part="scroll-prev" ${St(
          "previousFlipperContainer",
        )}><div class="scroll-action" part="scroll-action-previous"><slot name="previous-flipper">${
          e.previousFlipper instanceof Function
            ? e.previousFlipper(t, e)
            : null !== (i = e.previousFlipper) && void 0 !== i
            ? i
            : ""
        }</slot></div></div><div class="scroll scroll-next" part="scroll-next" ${St(
          "nextFlipperContainer",
        )}><div class="scroll-action" part="scroll-action-next"><slot name="next-flipper">${
    ...
    styles: ep,
    nextFlipper: _`<fluent-flipper @click="${(t) => t.scrollToNext()}" aria-hidden="${(t) =>
      t.flippersHiddenFromAT}"></fluent-flipper>`,
    previousFlipper: _`<fluent-flipper @click="${(t) => t.scrollToPrevious()}" direction="previous" aria-hidden="${(
      t,
    ) => t.flippersHiddenFromAT}"></fluent-flipper>`,
  }),
  sp = ep,
  np = (t, e) => vt`
    ${ln(
      "inline-flex",
    )} :host{border:calc(${dr} * 1px) solid ${fc};border-radius:calc(${cr} * 1px);box-sizing:border-box;flex-direction:column;padding:calc(${lr} * 1px) 0}::slotted(${t.tagFor(
      Mi,
    )}){margin:0 calc(${lr} * 1px)}:host(:focus-within:not([disabled])){${Yh}}`;
class rp extends Ni {}
const ap = rp.compose({
    baseName: "listbox",
    template: (t, e) =>
      _`<template aria-activedescendant="${(t) => t.ariaActiveDescendant}" aria-multiselectable="${(t) =>
        t.ariaMultiSelectable}" class="listbox" role="listbox" tabindex="${(t) =>
        t.disabled ? null : "0"}" @click="${(t, e) => t.clickHandler(e.event)}" @focusin="${(t, e) =>
        t.focusinHandler(e.event)}" @keydown="${(t, e) => t.keydownHandler(e.event)}" @mousedown="${(t, e) =>
        t.mousedownHandler(e.event)}"><slot ${Bt({
  ...
  cp = (t, e) =>
    ...
    ${ln("inline-flex")} :host{position:relative;${Bh}
      ...
      new ld(
        null,
        vt`
      :host::before{right:calc((${ur} - ${dr}) * 1px)}`,
      ),
      rn(vt`
  ...
  hp = Mi.compose({
    baseName: "option",
    template: (t, e) =>
      _`<template aria-checked="${(t) => t.ariaChecked}" aria-disabled="${(t) => t.ariaDisabled}" aria-posinset="${(
        t,
      ) => t.ariaPosInSet}" aria-selected="${(t) => t.ariaSelected}" aria-setsize="${(t) => t.ariaSetSize}" class="${(
        t,
      ) =>
        [t.checked && "checked", t.selected && "selected", t.disabled && "disabled"]
          .filter(Boolean)
          .join(" ")}" role="option">${_t(0, e)}<span class="content" part="content"><slot ${Bt(
        "content",
      )}></slot></span>${qt(0, e)}</template>`,
    styles: cp,
  }),
  dp = cp,
  up = (t, e) =>
    ...
    ${ln(
      "block",
    )} :host{background:${Ka};border:calc(${dr} * 1px) solid transparent;border-radius:calc(${hr} * 1px);box-shadow:${Id};padding:calc((${lr} - ${dr}) * 1px) 0;max-width:368px;min-width:64px}:host([slot='submenu']){width:max-content;margin:0 calc(${lr} * 2px)}::slotted(${t.tagFor(
      Wo,
    )}){margin:0 calc(${lr} * 1px)}::slotted(${t.tagFor(
      Ho,
    )}){margin:calc(${lr} * 1px) 0}::slotted(hr){box-sizing:content-box;height:0;margin:calc(${lr} * 1px) 0;border:none;border-top:calc(${dr} * 1px) solid ${Ic}}`.withBehaviors(
      rn(vt`
...
const gp = pp.compose({
    ...
    baseClass: Ko,
    template: (t, e) =>
      _`<template slot="${(t) => (t.slot ? t.slot : t.isNestedMenu() ? "submenu" : void 0)}" role="menu" @keydown="${(
        t,
        e,
      ) => t.handleMenuKeyDown(e.event)}" @focusout="${(t, e) => t.handleFocusOut(e.event)}"><slot ${Bt(
        "items",
      )}></slot></template>`,
    styles: up,
  }),
  ...
  mp = (t, e) =>
    ...
    ${ln("grid")} :host{contain:layout;overflow:visible;${Bh}
      ...
      new ld(
        vt`
        .expand-collapse-glyph-container{transform:rotate(0deg)}`,
        vt`
  ...
  vp = Wo.compose({
    baseName: "menu-item",
    template: (t, e) =>
      _`<template role="${(t) => t.role}" aria-haspopup="${(t) => (t.hasSubmenu ? "menu" : void 0)}" aria-checked="${(
        t,
      ) => (t.role !== Uo ? t.checked : void 0)}" aria-disabled="${(t) => t.disabled}" aria-expanded="${(t) =>
        t.expanded}" @keydown="${(t, e) => t.handleMenuItemKeyDown(e.event)}" @click="${(t, e) =>
        t.handleMenuItemClick(e.event)}" @mouseover="${(t, e) => t.handleMouseOver(e.event)}" @mouseout="${(t, e) =>
        t.handleMouseOut(e.event)}" class="${(t) => (t.disabled ? "disabled" : "")} ${(t) =>
        t.expanded ? "expanded" : ""} ${(t) => "indent-" + t.startColumnCount}">${Ot(
        (t) => t.role === qo,
        _`<div part="input-container" class="input-container"><span part="checkbox" class="checkbox"><slot name="checkbox-indicator">${
          e.checkboxIndicator || ""
        }</slot></span></div>`,
      )} ${Ot(
        (t) => t.role === _o,
        _`<div part="input-container" class="input-container"><span part="radio" class="radio"><slot name="radio-indicator">${
          e.radioIndicator || ""
        }</slot></span></div>`,
      )}</div>${_t(0, e)}<span class="content" part="content"><slot></slot></span>${qt(0, e)} ${Ot(
        (t) => t.hasSubmenu,
        _`<div part="expand-collapse-glyph-container" class="expand-collapse-glyph-container"><span part="expand-collapse" class="expand-collapse"><slot name="expand-collapse-indicator">${
          e.expandCollapseGlyph || ""
        }</slot></span></div>`,
      )} ${Ot(
        (t) => t.expanded,
        _`<${t.tagFor(oi)} :anchorElement="${(t) =>
          ...
          t,
        ) => t.currentDirection}" @loaded="${(t) => t.submenuLoaded()}" ${St(
          "submenuRegion",
        )} part="submenu-region"><slot name="submenu"></slot></${t.tagFor(oi)}>`,
      )}</template>`,
    styles: mp,
    checkboxIndicator:
      '\n    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">\n      <path d="M13.86 3.66a.5.5 0 01-.02.7l-7.93 7.48a.6.6 0 01-.84-.02L2.4 9.1a.5.5 0 01.72-.7l2.4 2.44 7.65-7.2a.5.5 0 01.7.02z"/>\n    </svg>\n  ',
...
const $p = yp,
  wp = xp.compose({
    ...
    styles: yp,
    template: (t, e) =>
      _`<template class="${(t) => (t.readOnly ? "readonly" : "")}"><label part="label" for="control" class="${(t) =>
        t.defaultSlottedNodes && t.defaultSlottedNodes.length ? "label" : "label label__hidden"}"><slot ${Bt(
        "defaultSlottedNodes",
      )}></slot></label><div class="root" part="root">${_t(
        0,
        e,
      )}<input class="control" part="control" id="control" @input="${(t) => t.handleTextInput()}" @change="${(t) =>
        t.handleChange()}" @keydown="${(t, e) => t.handleKeyDown(e.event)}" @blur="${(t, e) =>
        t.handleBlur()}" ?autofocus="${(t) => t.autofocus}" ?disabled="${(t) => t.disabled}" list="${(t) =>
        t.list}" maxlength="${(t) => t.maxlength}" minlength="${(t) => t.minlength}" placeholder="${(t) =>
        t.placeholder}" ?readonly="${(t) => t.readOnly}" ?required="${(t) => t.required}" size="${(t) =>
        t.size}" type="text" inputmode="numeric" min="${(t) => t.min}" max="${(t) => t.max}" step="${(t) =>
        t.step}" aria-atomic="${(t) => t.ariaAtomic}" aria-busy="${(t) => t.ariaBusy}" aria-controls="${(t) =>
        t.ariaControls}" aria-current="${(t) => t.ariaCurrent}" aria-describedby="${(t) =>
        t.ariaDescribedby}" aria-details="${(t) => t.ariaDetails}" aria-disabled="${(t) =>
        t.ariaDisabled}" aria-errormessage="${(t) => t.ariaErrormessage}" aria-flowto="${(t) =>
        t.ariaFlowto}" aria-haspopup="${(t) => t.ariaHaspopup}" aria-hidden="${(t) => t.ariaHidden}" aria-invalid="${(
        t,
      ) => t.ariaInvalid}" aria-keyshortcuts="${(t) => t.ariaKeyshortcuts}" aria-label="${(t) =>
        t.ariaLabel}" aria-labelledby="${(t) => t.ariaLabelledby}" aria-live="${(t) => t.ariaLive}" aria-owns="${(t) =>
        t.ariaOwns}" aria-relevant="${(t) => t.ariaRelevant}" aria-roledescription="${(t) =>
        t.ariaRoledescription}" ${St("control")} />${Ot(
        (t) => !t.hideStep && !t.readOnly && !t.disabled,
        _`<div class="controls" part="controls"><div class="step-up" part="step-up" @click="${(t) =>
          t.stepUp()}"><slot name="step-up-glyph">${
          e.stepUpGlyph || ""
        }</slot></div><div class="step-down" part="step-down" @click="${(t) =>
          t.stepDown()}"><slot name="step-down-glyph">${e.stepDownGlyph || ""}</slot></div></div>`,
      )} ${qt(0, e)}</div></template>`,
    shadowOptions: { delegatesFocus: !0 },
    stepDownGlyph:
      '\n    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg">\n      <path d="M2.15 4.65c.2-.2.5-.2.7 0L6 7.79l3.15-3.14a.5.5 0 11.7.7l-3.5 3.5a.5.5 0 01-.7 0l-3.5-3.5a.5.5 0 010-.7z"/>\n    </svg>\n  ',
...
const Ip = Cp.compose({
    baseName: "progress",
    template: (t, e) =>
      _`<template role="progressbar" aria-valuenow="${(t) => t.value}" aria-valuemin="${(t) =>
        t.min}" aria-valuemax="${(t) => t.max}" class="${(t) => (t.paused ? "paused" : "")}">${Ot(
        (t) => "number" == typeof t.value,
        _`<div class="progress" part="progress" slot="determinate"><div class="determinate" part="determinate" style="width: ${(
          t,
        ) => t.percentComplete}%"></div></div>`,
      )} ${Ot(
        (t) => "number" != typeof t.value,
        _`<div class="progress" part="progress" slot="indeterminate"><slot class="indeterminate" name="indeterminate">${
...
const Sp = Tp.compose({
    ...
    template: (t, e) =>
      _`<template role="progressbar" aria-valuenow="${(t) => t.value}" aria-valuemin="${(t) =>
        t.min}" aria-valuemax="${(t) => t.max}" class="${(t) => (t.paused ? "paused" : "")}">${Ot(
        (t) => "number" == typeof t.value,
        _`<svg class="progress" part="progress" viewBox="0 0 16 16" slot="determinate"><circle class="background" part="background" cx="8px" cy="8px" r="7px"></circle><circle class="determinate" part="determinate" style="stroke-dasharray: ${(
          t,
        ) => (44 * t.percentComplete) / 100}px ${44}px" cx="8px" cy="8px" r="7px"></circle></svg>`,
      )} ${Ot(
        (t) => "number" != typeof t.value,
        _`<slot name="indeterminate" slot="indeterminate">${e.indeterminateIndicator || ""}</slot>`,
      )}</template>`,
    styles: Dp,
    indeterminateIndicator:
  ...
  Vp = as.compose({
    baseName: "radio",
    template: (t, e) =>
      _`<template role="radio" class="${(t) => (t.checked ? "checked" : "")} ${(t) =>
        t.readOnly ? "readonly" : ""}" aria-checked="${(t) => t.checked}" aria-required="${(t) =>
        t.required}" aria-disabled="${(t) => t.disabled}" aria-readonly="${(t) => t.readOnly}" @keypress="${(t, e) =>
        t.keypressHandler(e.event)}" @click="${(t, e) =>
        t.clickHandler(e.event)}"><div part="control" class="control"><slot name="checked-indicator">${
        e.checkedIndicator || ""
      }</slot></div><label part="label" class="${(t) =>
        t.defaultSlottedNodes && t.defaultSlottedNodes.length ? "label" : "label label__hidden"}"><slot ${Bt(
        "defaultSlottedNodes",
  ...
  ${ln(
    "flex",
  )} :host{align-items:flex-start;flex-direction:column}.positioning-region{display:flex;flex-wrap:wrap}:host([orientation='vertical']) .positioning-region{flex-direction:column}:host([orientation='horizontal']) .positioning-region{flex-direction:row}`,
  Lp = ss.compose({
    baseName: "radio-group",
    template: (t, e) =>
      _`<template role="radiogroup" aria-disabled="${(t) => t.disabled}" aria-readonly="${(t) =>
        t.readOnly}" @click="${(t, e) => t.clickHandler(e.event)}" @keydown="${(t, e) =>
        t.keydownHandler(e.event)}" @focusout="${(t, e) =>
        t.focusOutHandler(e.event)}"><slot name="label"></slot><div class="positioning-region ${(t) =>
        t.orientation === Pe ? "horizontal" : "vertical"}" part="positioning-region"><slot ${Bt({
  ...
  zp = (t, e) =>
    _`<template class=" ${(t) => (t.readOnly ? "readonly" : "")} "><label part="label" for="control" class="${(t) =>
      ...
      filter: cs,
    })}></slot></label><div class="root" part="root" ${St("root")}>${_t(
      0,
      e,
    )}<div class="input-wrapper" part="input-wrapper"><input class="control" part="control" id="control" @input="${(
      t,
    ) => t.handleTextInput()}" @change="${(t) => t.handleChange()}" ?autofocus="${(t) => t.autofocus}" ?disabled="${(
      t,
    ) => t.disabled}" list="${(t) => t.list}" maxlength="${(t) => t.maxlength}" minlength="${(t) =>
      t.minlength}" pattern="${(t) => t.pattern}" placeholder="${(t) => t.placeholder}" ?readonly="${(t) =>
      t.readOnly}" ?required="${(t) => t.required}" size="${(t) => t.size}" ?spellcheck="${(t) =>
      t.spellcheck}" :value="${(t) => t.value}" type="search" aria-atomic="${(t) => t.ariaAtomic}" aria-busy="${(t) =>
      t.ariaBusy}" aria-controls="${(t) => t.ariaControls}" aria-current="${(t) => t.ariaCurrent}" aria-describedby="${(
      t,
    ) => t.ariaDescribedby}" aria-details="${(t) => t.ariaDetails}" aria-disabled="${(t) =>
      t.ariaDisabled}" aria-errormessage="${(t) => t.ariaErrormessage}" aria-flowto="${(t) =>
      ...
      t.ariaLabel}" aria-labelledby="${(t) => t.ariaLabelledby}" aria-live="${(t) => t.ariaLive}" aria-owns="${(t) =>
      t.ariaOwns}" aria-relevant="${(t) => t.ariaRelevant}" aria-roledescription="${(t) => t.ariaRoledescription}" ${St(
      "control",
    )} /><slot name="clear-button"><button class="clear-button ${(t) =>
      t.value ? "" : "clear-button__hidden"}" part="clear-button" tabindex="-1" @click=${(t) =>
      t.handleClearInput()}><slot name="clear-glyph"><svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg"><path d="m2.09 2.22.06-.07a.5.5 0 0 1 .63-.06l.07.06L6 5.29l3.15-3.14a.5.5 0 1 1 .7.7L6.71 6l3.14 3.15c.18.17.2.44.06.63l-.06.07a.5.5 0 0 1-.63.06l-.07-.06L6 6.71 2.85 9.85a.5.5 0 0 1-.7-.7L5.29 6 2.15 2.85a.5.5 0 0 1-.06-.63l.06-.07-.06.07Z" /></svg></slot></button></slot></div>${qt(
      0,
      e,
    )}</div></template>`,
...
const jp = Np.compose({
    ...
    styles: Bp,
    start:
      '<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg%22%3E"><path d="M8.5 3a5.5 5.5 0 0 1 4.23 9.02l4.12 4.13a.5.5 0 0 1-.63.76l-.07-.06-4.13-4.12A5.5 5.5 0 1 1 8.5 3Zm0 1a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9Z"/></svg>',
    shadowOptions: { delegatesFocus: !0 },
  }),
  Up = Bp;
class qp extends ms {
...
const _p = qp.compose({
    ...
    template: (t, e) =>
      _`<template class="${(t) =>
        [
          ...
          .filter(Boolean)
          .join(" ")}" aria-activedescendant="${(t) => t.ariaActiveDescendant}" aria-controls="${(t) =>
        t.ariaControls}" aria-disabled="${(t) => t.ariaDisabled}" aria-expanded="${(t) =>
        t.ariaExpanded}" aria-haspopup="${(t) => (t.collapsible ? "listbox" : null)}" aria-multiselectable="${(t) =>
        t.ariaMultiSelectable}" ?open="${(t) => t.open}" role="combobox" tabindex="${(t) =>
        t.disabled ? null : "0"}" @click="${(t, e) => t.clickHandler(e.event)}" @focusin="${(t, e) =>
        t.focusinHandler(e.event)}" @focusout="${(t, e) => t.focusoutHandler(e.event)}" @keydown="${(t, e) =>
        t.keydownHandler(e.event)}" @mousedown="${(t, e) => t.mousedownHandler(e.event)}">${Ot(
        (t) => t.collapsible,
        _`<div class="control" part="control" ?disabled="${(t) => t.disabled}" ${St("control")}>${_t(
          0,
          e,
        )}<slot name="button-container"><div class="selected-value" part="selected-value"><slot name="selected-value">${(
          t,
        ) =>
          t.displayValue}</slot></div><div aria-hidden="true" class="indicator" part="indicator"><slot name="indicator">${
          e.indicator || ""
        }</slot></div></slot>${qt(0, e)}</div>`,
      )}<div class="listbox" id="${(t) => t.listboxId}" part="listbox" role="listbox" ?disabled="${(t) =>
        t.disabled}" ?hidden="${(t) => !!t.collapsible && !t.open}" ${St("listbox")}><slot ${Bt({
        filter: Ni.slottedOptionFilter,
        flatten: !0,
        property: "slottedOptions",
      })}></slot></div></template>`,
  ...
  Wp = (t, e) =>
    ...
    ${ln(
      "block",
    )} :host{--skeleton-fill-default:${Wl};overflow:hidden;width:100%;position:relative;background-color:var(--skeleton-fill,var(--skeleton-fill-default));--skeleton-animation-gradient-default:linear-gradient(
        270deg,var(--skeleton-fill,var(--skeleton-fill-default)) 0%,${Kl} 51%,var(--skeleton-fill,var(--skeleton-fill-default)) 100%
      );--skeleton-animation-timing-default:ease-in-out}:host(.rect){border-radius:calc(${cr} * 1px)}:host(.circle){border-radius:100%;overflow:hidden}object{position:absolute;width:100%;height:auto;z-index:2}object img{width:100%;height:auto}${ln(
        "block",
      )} span.shimmer{position:absolute;width:100%;height:100%;background-image:var(--skeleton-animation-gradient,var(--skeleton-animation-gradient-default));background-size:0px 0px / 90% 100%;background-repeat:no-repeat;background-color:var(--skeleton-animation-fill,${Wl});animation:shimmer 2s infinite;animation-timing-function:var(--skeleton-animation-timing,var(--skeleton-timing-default));animation-direction:normal;z-index:1}::slotted(svg){z-index:2}::slotted(.pattern){width:100%;height:100%}@keyframes shimmer{0%{transform:translateX(-100%)}100%{transform:translateX(100%)}}`.withBehaviors(
      rn(vt`
        :host{background-color:${Ke.CanvasText}}`),
    ),
  Kp = bs.compose({
    baseName: "skeleton",
    template: (t, e) =>
      _`<template class="${(t) => ("circle" === t.shape ? "circle" : "rect")}" pattern="${(t) =>
        t.pattern}" ?shimmer="${(t) => t.shimmer}">${Ot(
        (t) => !0 === t.shimmer,
        _`<span class="shimmer"></span>`,
      )}<object type="image/svg+xml" data="${(t) => t.pattern}" role="presentation"><img class="pattern" src="${(t) =>
  ...
  Qp = Is.compose({
    baseName: "slider",
    template: (t, e) =>
      _`<template role="slider" class="${(t) => (t.readOnly ? "readonly" : "")} ${(t) =>
        t.orientation || Pe}" tabindex="${(t) => (t.disabled ? null : 0)}" aria-valuetext="${(t) =>
        t.valueTextFormatter(t.value)}" aria-valuenow="${(t) => t.value}" aria-valuemin="${(t) =>
        t.min}" aria-valuemax="${(t) => t.max}" aria-disabled="${(t) => !!t.disabled || void 0}" aria-readonly="${(t) =>
        !!t.readOnly || void 0}" aria-orientation="${(t) => t.orientation}" class="${(t) =>
        t.orientation}"><div part="positioning-region" class="positioning-region"><div ${St(
        "track",
      )} part="track-container" class="track"><slot name="track"></slot><div part="track-start" class="track-start" style="${(
        t,
      ) => t.position}"><slot name="track-start"></slot></div></div><slot></slot><div ${St(
        "thumb",
      )} part="thumb-container" class="thumb-container" style="${(t) => t.position}"><slot name="thumb">${
        e.thumb || ""
  ...
  tg = $s.compose({
    ...
    template: (t, e) =>
      _`<template aria-disabled="${(t) => t.disabled}" class="${(t) => t.sliderOrientation || Pe} ${(t) =>
        t.disabled ? "disabled" : ""}"><div ${St("root")} part="root" class="root" style="${(t) =>
        t.positionStyle}"><div class="container">${Ot(
        (t) => !t.hideMark,
        _`<div class="mark"></div>`,
  ...
  ig = (t, e) =>
    ...
    :host([hidden]){display:none}${ln(
      ...
      margin-inline-end:calc(${lr} * 2px + 2px);cursor:pointer}::slotted([slot="checked-message"]),::slotted([slot="unchecked-message"]){margin-inline-start:calc(${lr} * 2px + 2px)}:host(.checked) .switch{background:${rl}}:host(.checked) .switch slot[name='switch']{fill:${dl};filter:drop-shadow(0px 1px 1px rgba(0,0,0,0.15))}:host(.checked:not(.disabled)) .switch:hover{background:${al}}:host(.checked:not(.disabled)) .switch:hover slot[name='switch']{fill:${ul}}:host(.checked:not(.disabled)) .switch:active{background:${ll}}:host(.checked:not(.disabled)) .switch:active slot[name='switch']{fill:${pl}}.unchecked-message{display:block}.checked-message{display:none}:host(.checked) .unchecked-message{display:none}:host(.checked) .checked-message{display:block}`.withBehaviors(
      new ld(
        vt`
        slot[name='switch']{left:0}:host(.checked) slot[name='switch']{left:100%;transform:translateX(-100%)}`,
        vt`
  ...
  og = Ts.compose({
    baseName: "switch",
    template: (t, e) =>
      _`<template role="switch" aria-checked="${(t) => t.checked}" aria-disabled="${(t) =>
        t.disabled}" aria-readonly="${(t) => t.readOnly}" tabindex="${(t) => (t.disabled ? null : 0)}" @keypress="${(
        t,
        e,
      ) => t.keypressHandler(e.event)}" @click="${(t, e) => t.clickHandler(e.event)}" class="${(t) =>
  ...
  ng = (t, e) =>
    vt`
      ...
      rn(vt`
        .activeIndicator,:host(.vertical) .activeIndicator{background:${Ke.Highlight}}`),
    ),
  rg = (t, e) =>
    vt`
  ...
  ag = Os.compose({
    baseName: "tab",
    template: (t, e) =>
      _`<template slot="tab" role="tab" aria-disabled="${(t) => t.disabled}"><slot></slot></template>`,
    styles: rg,
  }),
  lg = rg,
  cg = (t, e) => vt`
  ${ln("block")} :host{box-sizing:border-box;${Bh}
    padding:0 calc((6 + (${lr} * 2 * ${ar})) * 1px)}`,
  hg = Ss.compose({
    baseName: "tab-panel",
  ...
  ug = Vs.compose({
    baseName: "tabs",
    template: (t, e) =>
      _`<template class="${(t) => t.orientation}">${_t(
        0,
        e,
      )}<div class="tablist" part="tablist" role="tablist"><slot class="tab" name="tab" part="tab" ${Bt(
        "tabs",
      )}></slot>${Ot(
        (t) => t.showActiveIndicator,
        _`<div ${St("activeIndicatorRef")} class="activeIndicator" part="activeIndicator"></div>`,
      )}</div>${qt(0, e)}<div class="tabpanel" part="tabpanel"><slot name="tabpanel" ${Bt(
        "tabpanels",
      )}></slot></div></template>`,
    styles: ng,
  }),
  ...
  gg = (t, e) =>
    ...
    :host{flex-direction:column;vertical-align:bottom}.control{height:calc((${Zh} * 2) * 1px);padding:calc(${lr} * 1.5px) calc(${lr} * 2px + 1px)}:host .control{resize:none}:host(.resize-both) .control{resize:both}:host(.resize-horizontal) .control{resize:horizontal}:host(.resize-vertical) .control{resize:vertical}:host([cols]){width:initial}:host([rows]) .control{height:initial}`.withBehaviors(
      qd("outline", Nd(0, 0, ".control")),
      qd("filled", jd(0, 0, ".control")),
      rn(Ud(0, 0, ".control")),
    );
class fg extends Ps {
  appearanceChanged(t, e) {
...
const mg = fg.compose({
    ...
    baseClass: Ps,
    template: (t, e) =>
      _`<template class=" ${(t) => (t.readOnly ? "readonly" : "")} ${(t) =>
        t.resize !== Ls ? "resize-" + t.resize : ""}"><label part="label" for="control" class="${(t) =>
        t.defaultSlottedNodes && t.defaultSlottedNodes.length ? "label" : "label label__hidden"}"><slot ${Bt(
        "defaultSlottedNodes",
      )}></slot></label><textarea part="control" class="control" id="control" ?autofocus="${(t) =>
        t.autofocus}" cols="${(t) => t.cols}" ?disabled="${(t) => t.disabled}" form="${(t) => t.form}" list="${(t) =>
        t.list}" maxlength="${(t) => t.maxlength}" minlength="${(t) => t.minlength}" name="${(t) =>
        t.name}" placeholder="${(t) => t.placeholder}" ?readonly="${(t) => t.readOnly}" ?required="${(t) =>
        t.required}" rows="${(t) => t.rows}" ?spellcheck="${(t) => t.spellcheck}" :value="${(t) =>
        t.value}" aria-atomic="${(t) => t.ariaAtomic}" aria-busy="${(t) => t.ariaBusy}" aria-controls="${(t) =>
        t.ariaControls}" aria-current="${(t) => t.ariaCurrent}" aria-describedby="${(t) =>
        t.ariaDescribedby}" aria-details="${(t) => t.ariaDetails}" aria-disabled="${(t) =>
        t.ariaDisabled}" aria-errormessage="${(t) => t.ariaErrormessage}" aria-flowto="${(t) =>
        t.ariaFlowto}" aria-haspopup="${(t) => t.ariaHaspopup}" aria-hidden="${(t) => t.ariaHidden}" aria-invalid="${(
        ...
        t.ariaLabel}" aria-labelledby="${(t) => t.ariaLabelledby}" aria-live="${(t) => t.ariaLive}" aria-owns="${(t) =>
        t.ariaOwns}" aria-relevant="${(t) => t.ariaRelevant}" aria-roledescription="${(t) =>
        t.ariaRoledescription}" @input="${(t, e) => t.handleTextInput()}" @change="${(t) => t.handleChange()}" ${St(
        "control",
      )}></textarea></template>`,
    styles: gg,
    shadowOptions: { delegatesFocus: !0 },
...
const xg = yg.compose({
    ...
    template: (t, e) =>
      _`<template class=" ${(t) => (t.readOnly ? "readonly" : "")} "><label part="label" for="control" class="${(t) =>
        ...
        t.handleChange()}" ?autofocus="${(t) => t.autofocus}" ?disabled="${(t) => t.disabled}" list="${(t) =>
        t.list}" maxlength="${(t) => t.maxlength}" minlength="${(t) => t.minlength}" pattern="${(t) =>
        t.pattern}" placeholder="${(t) => t.placeholder}" ?readonly="${(t) => t.readOnly}" ?required="${(t) =>
        t.required}" size="${(t) => t.size}" ?spellcheck="${(t) => t.spellcheck}" :value="${(t) => t.value}" type="${(
        t,
      ) => t.type}" aria-atomic="${(t) => t.ariaAtomic}" aria-busy="${(t) => t.ariaBusy}" aria-controls="${(t) =>
        t.ariaControls}" aria-current="${(t) => t.ariaCurrent}" aria-describedby="${(t) =>
        t.ariaDescribedby}" aria-details="${(t) => t.ariaDetails}" aria-disabled="${(t) =>
        t.ariaDisabled}" aria-errormessage="${(t) => t.ariaErrormessage}" aria-flowto="${(t) =>
        t.ariaFlowto}" aria-haspopup="${(t) => t.ariaHaspopup}" aria-hidden="${(t) => t.ariaHidden}" aria-invalid="${(
        ...
        t.ariaLabel}" aria-labelledby="${(t) => t.ariaLabelledby}" aria-live="${(t) => t.ariaLive}" aria-owns="${(t) =>
        t.ariaOwns}" aria-relevant="${(t) => t.ariaRelevant}" aria-roledescription="${(t) =>
        t.ariaRoledescription}" ${St("control")} />${qt(0, e)}</div></template>`,
    styles: bg,
    shadowOptions: { delegatesFocus: !0 },
  }),
  $g = bg;
...
const kg = wg.compose({
  ...
  baseClass: Hs,
  template: (t, e) =>
    _`<template aria-label="${(t) => t.ariaLabel}" aria-labelledby="${(t) => t.ariaLabelledby}" aria-orientation="${(
      t,
    ) => t.orientation}" orientation="${(t) => t.orientation}" role="toolbar" @click="${(t, e) =>
      t.clickHandler(e.event)}" @focusin="${(t, e) => t.focusinHandler(e.event)}" @keydown="${(t, e) =>
      t.keydownHandler(e.event)}" ${jt({
      property: "childItems",
...
const Ig = Cg.compose({
    ...
    template: (t, e) =>
      _` ${Ot(
        (t) => t.tooltipVisible,
        _`<${t.tagFor(oi)} fixed-placement="true" auto-update-mode="${(t) =>
          t.autoUpdateMode}" vertical-positioning-mode="${(t) =>
          t.verticalPositioningMode}" vertical-default-position="${(t) =>
          t.verticalDefaultPosition}" vertical-inset="${(t) => t.verticalInset}" vertical-scaling="${(t) =>
          t.verticalScaling}" horizontal-positioning-mode="${(t) =>
          t.horizontalPositioningMode}" horizontal-default-position="${(t) =>
          t.horizontalDefaultPosition}" horizontal-scaling="${(t) => t.horizontalScaling}" horizontal-inset="${(t) =>
          t.horizontalInset}" vertical-viewport-lock="${(t) => t.horizontalViewportLock}" horizontal-viewport-lock="${(
          t,
        ) => t.verticalViewportLock}" dir="${(t) => t.currentDirection}" ${St(
          "region",
        )}><div class="tooltip" part="tooltip" role="tooltip"><slot></slot></div></${t.tagFor(oi)}>`,
      )} `,
    styles: (t, e) =>
      vt`
    :host{position:relative;contain:layout;overflow:visible;height:0;width:0;z-index:10000}.tooltip{box-sizing:border-box;border-radius:calc(${cr} * 1px);border:calc(${dr} * 1px) solid ${Vc};background:${ol};color:${lc};padding:4px 12px;height:fit-content;width:fit-content;${Bh}
      white-space:nowrap;box-shadow:${kd}}${t.tagFor(
        oi,
      )}{display:flex;justify-content:center;align-items:center;overflow:visible;flex-direction:row}${t.tagFor(
        oi,
      )}.right,${t.tagFor(oi)}.left{flex-direction:column}${t.tagFor(oi)}.top .tooltip::after,${t.tagFor(
        oi,
      )}.bottom .tooltip::after,${t.tagFor(oi)}.left .tooltip::after,${t.tagFor(
        oi,
      )}.right .tooltip::after{content:'';width:12px;height:12px;background:${ol};border-top:calc(${dr} * 1px) solid ${Vc};border-left:calc(${dr} * 1px) solid ${Vc};position:absolute}${t.tagFor(
        oi,
      )}.top .tooltip::after{transform:translateX(-50%) rotate(225deg);bottom:5px;left:50%}${t.tagFor(
        oi,
      )}.top .tooltip{margin-bottom:12px}${t.tagFor(
        oi,
      )}.bottom .tooltip::after{transform:translateX(-50%) rotate(45deg);top:5px;left:50%}${t.tagFor(
        oi,
      )}.bottom .tooltip{margin-top:12px}${t.tagFor(
        oi,
      )}.left .tooltip::after{transform:translateY(-50%) rotate(135deg);top:50%;right:5px}${t.tagFor(
        oi,
      )}.left .tooltip{margin-right:12px}${t.tagFor(
        oi,
      )}.right .tooltip::after{transform:translateY(-50%) rotate(-45deg);top:50%;left:5px}${t.tagFor(
        oi,
      )}.right .tooltip{margin-left:12px}`.withBehaviors(
        rn(vt`
        :host([disabled]){opacity:1}${t.tagFor(oi)}.top .tooltip::after,${t.tagFor(
          oi,
        )}.bottom .tooltip::after,${t.tagFor(oi)}.left .tooltip::after,${t.tagFor(
          oi,
        )}.right .tooltip::after{content:'';width:unset;height:unset}`),
      ),
  }),
  Fg = (t, e) => vt`
  :host([hidden]){display:none}${ln(
    "flex",
  )} :host{flex-direction:column;align-items:stretch;min-width:fit-content;font-size:0}`,
  Dg = sn.compose({
    baseName: "tree-view",
    template: (t, e) =>
      _`<template role="tree" ${St("treeView")} @keydown="${(t, e) => t.handleKeyDown(e.event)}" @focusin="${(t, e) =>
        t.handleFocus(e.event)}" @focusout="${(t, e) => t.handleBlur(e.event)}" @click="${(t, e) =>
        t.handleClick(e.event)}" @selected-change="${(t, e) => t.handleSelectedChange(e.event)}"><slot ${Bt(
        "slottedTreeItems",
      )}></slot></template>`,
    styles: Fg,
  }),
  ...
  Lg = on.compose({
    baseName: "tree-item",
    template: (t, e) =>
      _`<template role="treeitem" slot="${(t) => (t.isNestedItem() ? "item" : void 0)}" tabindex="-1" class="${(t) =>
        t.expanded ? "expanded" : ""} ${(t) => (t.selected ? "selected" : "")} ${(t) => (t.nested ? "nested" : "")} ${(
        t,
      ) => (t.disabled ? "disabled" : "")}" aria-expanded="${(t) =>
        t.childItems && t.childItemLength() > 0 ? t.expanded : void 0}" aria-selected="${(t) =>
        t.selected}" aria-disabled="${(t) => t.disabled}" @focusin="${(t, e) => t.handleFocus(e.event)}" @focusout="${(
        t,
        e,
      ) => t.handleBlur(e.event)}" ${jt({
        property: "childItems",
        filter: zt(),
      })}><div class="positioning-region" part="positioning-region"><div class="content-region" part="content-region">${Ot(
        (t) => t.childItems && t.childItemLength() > 0,
        _`<div aria-hidden="true" class="expand-collapse-button" part="expand-collapse-button" @click="${(t, e) =>
          t.handleExpandCollapseButtonClick(e.event)}" ${St(
          "expandCollapseButton",
        )}><slot name="expand-collapse-glyph">${e.expandCollapseGlyph || ""}</slot></div>`,
      )} ${_t(0, e)}<slot></slot>${qt(0, e)}</div></div>${Ot(
        (t) => t.childItems && t.childItemLength() > 0 && (t.expanded || t.renderCollapsedChildren),
        _`<div role="group" class="items" part="items"><slot name="item" ${Bt("items")}></slot></div>`,
      )}</template>`,
    styles: Ag,
    expandCollapseGlyph:
      '\n    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg">\n      <path d="M4.65 2.15a.5.5 0 000 .7L7.79 6 4.65 9.15a.5.5 0 10.7.7l3.5-3.5a.5.5 0 000-.7l-3.5-3.5a.5.5 0 00-.7 0z"/>\n    </svg>\n  ',
